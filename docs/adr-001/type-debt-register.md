...
- **The generalisable part:** _an exclusion list is a ratchet or it is debt._ Writing "this list may only shrink" next to the list changes nothing a reviewer has to notice; the same sentence as a CI check is the only version that survives a rushed conversion PR.
