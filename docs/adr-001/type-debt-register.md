...
| [TD-20](#td-20) | 🟡 low    | Deprecation  | Deprecated request APIs (`setResult(result, options)`, `getArrayLegacy`) kept in converted controllers — [#2688](https://github.com/kuzzleio/kuzzle/issues/2688), [#2721](https://github.com/kuzzleio/kuzzle/issues/2721) · **both fixed; `input.resource` residual**                                                                                                                                                              | S      | 🟦                                                                                                                                                                                                                                       |
...
> **🟦 Both tracked halves fixed (2026-09-25); one unfiled residual left.**
>
...
> - **Residual:** `lib/core/validation/validation.ts` reads the deprecated `request.input.resource` under a `NOSONAR` naming TD-20, and no issue tracks it. Not part of #2688 or #2721; left for its own look.
