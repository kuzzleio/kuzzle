...
- **All 51 PR checks green** (lint ×3, error-codes, ratchets & strict, unit mocha+vitest ×3 node versions, build&run, functional http/websocket/legacy ×3, cluster monkey, Sonar).
