...
**Remaining JS by layer** (50 = 46 `lib/` + 4 `bin/`; **49 once [#2713](https://github.com/kuzzleio/kuzzle/pull/2713) lands**): `core` **34** (validation 15 · network 14 · plugin 5) · `api` **0** · `kuzzle` 6 · `cluster` 6 · `bin` 4 → **3**, all plugin **fixtures** under `bin/plugins/available/**`, i.e. the floor.
...
0. **The five review follow-ups are all in review** (opened 2026-09-10, each off `2-dev`, none stacked): [#2709](https://github.com/kuzzleio/kuzzle/pull/2709) TD-27 · [#2710](https://github.com/kuzzleio/kuzzle/pull/2710) TD-28 · [#2711](https://github.com/kuzzleio/kuzzle/pull/2711) TD-31 · [#2712](https://github.com/kuzzleio/kuzzle/pull/2712) TD-29 · [#2713](https://github.com/kuzzleio/kuzzle/pull/2713) TD-30. Merge them before opening sprint 6, and **close their issues by hand**. Two further findings came out of the pass and are themselves in flight: [#2714](https://github.com/kuzzleio/kuzzle/issues/2714) (TD-32, `tsconfig.json`'s dead `rootDir`) fixed in [#2716](https://github.com/kuzzleio/kuzzle/pull/2716), and [#2715](https://github.com/kuzzleio/kuzzle/issues/2715) (TD-33, the functional matrix's flaky variant blocking unrelated PRs) still open — it is what forced two of today's re-runs.
