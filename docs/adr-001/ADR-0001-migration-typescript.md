...
0. **The five review follow-ups are all in review** (opened 2026-09-10, each off `2-dev`, none stacked): [#2709](https://github.com/kuzzleio/kuzzle/pull/2709) TD-27 · [#2710](https://github.com/kuzzleio/kuzzle/pull/2710) TD-28 · [#2711](https://github.com/kuzzleio/kuzzle/pull/2711) TD-31 · [#2712](https://github.com/kuzzleio/kuzzle/pull/2712) TD-29 · [#2713](https://github.com/kuzzleio/kuzzle/pull/2713) TD-30. Merge them before opening sprint 6, and **close their issues by hand**. One new finding came out of TD-30: [#2714](https://github.com/kuzzleio/kuzzle/issues/2714) (TD-32, `tsconfig.json`'s dead `rootDir`), unscheduled.
