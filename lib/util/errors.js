...
function get (domain, subdomain, error, ...placeholders) {
  ...
  if (! kuzzleError) {
    return get('internal', 'unexpected', 'unexpected_error', ...placeholders);
  }
...
function throwFrom (source, domain, subdomain, error, ...placeholders) {
  throw getFrom(source, domain, subdomain, error, ...placeholders);
}
...
function wrap (domain, subdomain) {
  return {
    ...
    getFrom: (source, error, ...placeholders) => getFrom(
      ...
      error,
      ...placeholders),
    throwFrom: (source, error, ...placeholders) => throwError(
      source,
      domain,
      subdomain,
      error,
