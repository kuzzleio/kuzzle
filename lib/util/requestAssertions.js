...
module.exports = {
  ...
  assertBodyHasNotAttribute: (request, attribute) => {
    if (!_.isNil(request.input.body[attribute])) {
      assertionError.throw('unexpected_argument', `body.${attribute}`);
    }
  },
  ...
  assertBodyAttributeType: (request, attribute, type) => {
    ...
    assertionError.throw('invalid_type', attribute, type);
  },
  ...
  assertContentHasNotAttribute: (request, attribute) => {
    if (request.input.body.content[attribute]) {
      assertionError.throw('unexpected_argument', `body.content.${attribute}`);
    }
  },
  ...
  assertIsObject: value => {
    if (value === null || typeof value !== 'object' || Array.isArray(value)) {
      assertionError.throw('invalid_type', value, 'object');
    }
  }
};
