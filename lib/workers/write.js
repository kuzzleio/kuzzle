...
function onListenCB (serializedRequestObject) {
  ...
  this.kuzzle.services.list.writeEngine[serializedRequestObject.action](serializedRequestObject)
    .then(function (result) {
      ...
      this.kuzzle.services.list.broker.add(responseObject.uniqueRoom, responseObject.toJson());
    ...
    .catch(function (error) {
      this.kuzzle.services.list.broker.add(serializedRequestObject.uniqueRoom, {error: error});
