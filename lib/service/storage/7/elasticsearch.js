...
class ES7 {
    ...
    async _initSequence() {
        ...
        if (version &&
            !semver_1.default.satisfies(semver_1.default.coerce(version.number), ">= 7.0.0")) {
    ...
    async bulkUpdateByQuery(index, collection, query, changes, { refresh = false, } = {}) {
        ...
        if (response.body.failures.length) {
            ...
            throw kerror.get("services", "storage", "incomplete_update", response.body.updated, errors);
        }
        return {
    ...
    async mExecute(index, collection, query, callback, { size = 10, scrollTTl = "5s", } = {}) {
        ...
        let scrollId = null;
        try {
            results = await new bluebird_1.default((resolve, reject) => {
                this._client.search(esRequest, async function getMoreUntilDone(error, { body: { hits, _scroll_id } }) {
                    if (error) {
                        reject(error);
                        return;
                    }
