...
const scopeEnum = require('../../core/storage/storageScopeEnum');
...
class ElasticSearch extends Service {
    ...
    try {
      ...
      if (fetched >= body.hits.total.value) {
        ...
        await this._kuzzle.ask(
          ...
          cacheKey,
          fetched,
          (ms(_scrollTTL) || this.scrollTTL) / 1000);
      }
  ...
  */
   ...
   *
   * @returns {Promise.<Object>} { dynamic, _meta, properties }
   */
  ...
  */
   ...
   *
   * @returns {Promise.<Object>} { documents, errors }
   */
  async mDelete (
    index,
    collection,
