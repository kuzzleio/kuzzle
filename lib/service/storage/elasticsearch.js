  ...
  */
  ...
  async updateCollection (index, collection, { mappings = {}, settings = {} } = {}) {
    ...
    try {
      ...
      const allowedSettings = this.getAllowedSettings(indexSettings);
  ...
  /**
   * Give index settings we return a new version of settings
   * only with allowed settings to be can be setted (during update or create index).
   * @param indexSettings the index settings
   * @returns {{index: *}} a new index settings with only allowed settings.
   */
  getAllowedSettings (indexSettings) {
    return {
      index: _.omit(
        indexSettings.index,
  ...
  */
  ...
  async truncateCollection (index, collection) {
    ...
    try {
      ...
      settings = this.getAllowedSettings(settings);
