...
KuzzleProxy.prototype.init = function () {
  ...
  this.kuzzle.services.list.proxyBroker.send('httpPortInitialization', {httpPort: this.kuzzle.config.httpPort});
};
...
KuzzleProxy.prototype.dispatch = function (event, data) {
