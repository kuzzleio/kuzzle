...
function HotelClerk (kuzzle) {
   ...
   */
  this.addSubscription = function hotelClerkAddSubscription (requestObject, context) {
    var diff = [];
   ...
   */
  this.getChannels = function hotelClerkGetChannels (roomId, notification) {
    var channels = [];
   ...
   */
  this.removeSubscription = function hotelClerkRemoveSubscription (requestObject, context) {
    var
   ...
   */
  this.listSubscriptions = function hotelClerkListSubscriptions (context) {
   ...
   * @returns {Promise}
   */
  this.join = function hotelClerkJoin (requestObject, context) {
    var
