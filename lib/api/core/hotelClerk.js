...
function removeAllRoomsInCollection (index, collection) {
  ...
  console.log('removeAllRoomsInCollection', index, collection);
  console.log(this.kuzzle.dsl.filtersTree[index][collection])
  console.log(this.kuzzle.dsl.filtersTree[index][collection].rooms)
...
function cleanUpRooms (roomId) {
  console.log('cleanUpRooms', roomId);
  var deferred = q.defer();
...
function removeRoomEverywhere (roomId) {
  console.log('removeRoomEverywhere', roomId);
