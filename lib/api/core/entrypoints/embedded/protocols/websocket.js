...
const
  errorsManager = require('../../../../../config/error-codes/throw').wrap('protocols', 'websocket'),
  ...
  onClientMessage(connection, data) {
    ...
    try {
      ...
      const errRequest = new Request(
        ...
        {
          connection,
          error: errorsManager.getError('websocket_request_error', e.message)
        });
    ...
    try {
      ...
      this.entryPoint.kuzzle.log.error(new KuzzleInternalError(e.message));
