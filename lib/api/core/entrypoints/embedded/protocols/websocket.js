...
class WebSocketProtocol extends Protocol {
  constructor () {
    ...
    // idleTimeout controls the min. amount of inactivity of a socket:
    // this value controls how often a sweep is performed on inactive sockets
    // (a cleanup every so often is largely enough)
    this.idleSweepDelay = 30 * 60 * 1000;
