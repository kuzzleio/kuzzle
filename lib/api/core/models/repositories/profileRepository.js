module.exports = function (kuzzle) {
  ...
  ProfileRepository.prototype.hydrate = function (profile, data) {
    ...
    q(_.assignIn(profile, data))
      .then(result => {
        o = result;
        return kuzzle.repositories.role.loadRoles(extractRoleIds(result.policies));
      })
      .then((roles) => {
        var
          rolesNotFound = _.difference(extractRoleIds(o.policies), extractRoleIds(roles));
