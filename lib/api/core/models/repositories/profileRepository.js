module.exports = function (kuzzle) {
  ...
  ProfileRepository.prototype.loadProfile = function (profile) {
    ...
    if (this.profiles[profileId]) {
      ...
      console.log('loadProfile cache', profile, this.profiles[profileId]);
      return this.hydrate(p, this.profiles[profileId]);
    }

    console.log('loadProfile pre:db', profileId);
    this.loadOneFromDatabase(profileId)
      .then((result) => {
        console.log('loadProfile db', profile, result);
        if (result) {
  ...
  ProfileRepository.prototype.buildProfileFromRequestObject = function (requestObject) {
    ...
    console.log('buildProfileFromRequestObject', requestObject, profile);
