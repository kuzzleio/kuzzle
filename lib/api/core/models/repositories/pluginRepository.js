...
class PluginRepository extends Repository {
  ...
  create (object, options = {}) {
    return this.persistToDatabase(object, {method: 'create'}, options);
  }
  ...
  createOrReplace (object, options = {}) {
    return this.persistToDatabase(object, {method: 'createOrReplace'}, options);
  }
  ...
  replace (object, options = {}) {
    return this.persistToDatabase(object, {method: 'replace'}, options);
  }
  ...
  update (object, options = {}) {
    ...
    return this.persistToDatabase(object, {method: 'update'}, options);
  }
  ...
  delete (documentId, options = {}) {
    return super.delete(documentId, options);
  }
}
