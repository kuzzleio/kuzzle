...
/*Repository.prototype.hydrate = function (object, data) {
  if (!_.isObject(data)) {
    return q.reject(new InternalError('Error hydrating object ' + object.toString() + '. Data parameter is not an object'));
  }

  return q(_.assignIn(object, data));
};*/
