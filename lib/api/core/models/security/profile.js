 ...
 * @return {Promise}
 */
Profile.prototype.getRoles = function profileGetRoles (kuzzle) {
  var promises;
 ...
 * @return Promise
 */
Profile.prototype.isActionAllowed = function profileIsActionAllowed (requestObject, userContext, kuzzle) {
    ...
    .then(roles => {
      return new Promise(resolve => {
        async.some(roles, (role, callback) => {
          role.isActionAllowed(requestObject, userContext, kuzzle)
 ...
 * @return {Promise}
 */
Profile.prototype.validateDefinition = function profileValidateDefinition () {
 ...
 * @return {Promise}
 */
Profile.prototype.getRights = function profileGetRights (kuzzle) {
  var profileRights = {};
