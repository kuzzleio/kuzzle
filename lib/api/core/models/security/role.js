...
Role.prototype.isActionAllowed = function (requestObject, context, restrictions, kuzzle) {
  ...
  if (_.includes(['createCollection'], requestObject.action) &&
    ...
    promises.push(canCreateIndex.call(this, requestObject.index, context, restrictions, kuzzle));
  }
  ...
  if (_.includes(['import', 'create', 'updateMapping', 'createOrReplace'], requestObject.action) &&
    ...
    promises.push(canCreateCollection.call(this, requestObject.index, requestObject.collection, context, restrictions, kuzzle));
  }
  ...
  promises.push(checkRestrictions(requestObject, restrictions));
...
function canCreateIndex(index, context, restrictions, kuzzle) {
  var
    rq = {
      controller: 'admin',
      action: 'createIndex',
  ...
  return this.isActionAllowed(rq, context, restrictions, kuzzle);
}


function canCreateCollection(index, collection, context, restrictions, kuzzle) {
  var
    rq = {
      controller: 'admin',
