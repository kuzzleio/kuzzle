 ...
 * @returns {Promise}
 */
Role.prototype.isActionAllowed = function roleIsActionAllowed (requestObject, context, kuzzle) {
  var
    controllerRights,
    actionRights,
    promises = [],
 ...
 * @returns {Promise}
 */
Role.prototype.validateDefinition = function roleValidateDefinition (context) {
