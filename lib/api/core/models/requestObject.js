...
module.exports = RequestObject = function RequestObject(object, additionnalData) {
  ...
  this.prefixUniqueRoom = 'write_response_';
  ...
  this.isValid = function () {
    ...
    return (this.data.body !== undefined && !_.isEmpty(this.data.body));
  };
...
function construct (object, additionalData) {
  ...
  // Add a internal private room name for identify when we get the response from WriteEngine
  this.uniqueRoom = this.prefixUniqueRoom + uuid.v1();
