...
class PluginContext {
  ...
  constructor(kuzzle, pluginName) {
    ...
    if (kuzzle instanceof Kuzzle) {
      ...
      /**
       *  @deprecated execute will be removed in v2, replaced by "sdk" accessor
       */
      this.accessors = deprecateProperties(this.accessors, {
        execute: { message: '\'execute\' usage is deprecated. Please use the embedded sdk instead.' }
      });

      /**
       *  @deprecated Dsl will be removed in v2, replaced by "Koncorde" constructor
       */
      this.constructors = deprecateProperties(this.constructors, {
        Dsl: 'Koncorde'
      });
