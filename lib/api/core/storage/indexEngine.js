...
class IndexEngine {
   ...
   */
  get (collection, id) {
    return this.storage.get(this.index, collection, id);
  }
   ...
   */
  mGet (collection, ids) {
    return this.storage.mGet(this.index, collection, ids);
  }
  ...
  create (collection, id, content, options = {}) {
    ...
    return this.storage.create(this.index, collection, content, opts);
  }
  ...
  createOrReplace (collection, id, content, options = {}) {
    ...
    return this.storage.createOrReplace(
      this.index,
      collection,
      id,
      content,
  ...
  update (collection, id, content, options = {}) {
    ...
    return this.storage.update(this.index, collection, id, content, opts);
  }
  ...
  delete (collection, id, options = {}) {
    ...
    return this.storage.delete(this.index, collection, id, opts);
  }
  ...
  exists (collection, id) {
    return this.storage.exists(this.index, collection, id);
  }
