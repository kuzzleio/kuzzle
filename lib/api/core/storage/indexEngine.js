...
class IndexEngine {
   ...
   * @param {Number} scrollTTL - scrollTTL (default scrollTTL)
   *
   ...
   */
  count (collection, searchBody = {}) {
    return this.storageEngine.count(this.index, collection, searchBody);
  }
  ...
  async createCollection (collection, mappings = {}) {
    await this.storageEngine.createCollection(this.index, collection, mappings);
  ...
  async refreshCollection (collection) {
    await this.storageEngine.refreshCollection(this.index, collection);
  }
   ...
   */
  async deleteIndex () {
    await this.storageEngine.deleteIndex(this.index);
