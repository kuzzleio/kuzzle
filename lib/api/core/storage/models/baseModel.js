...
class BaseModel {
  constructor (_source, _id) {
    ...
    for (const field of this.constructor.fields) {
      //  @todo use Reflect everywhere in kuzzle
  ...
  async delete ({ refresh }) {
    ...
    await BaseModel.indexStorage.delete(this.constructor.collection, this._id, { refresh });
  }
  ...
  static register (ModelClass, collection, fields) {
