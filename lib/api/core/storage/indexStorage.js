...
class IndexStorage {
  ...
  constructor (kuzzle, index, storageEngine) {
    ...
    for (const method of this.rawMethods) {
      this[method] = (...args) => this._storageEngine[method](this.index, ...args);
    }
  }
  ...
  create (collection, id, content, options = {}) {
    ...
    return this._storageEngine.create(this.index, collection, content, opts);
  }
  ...
  createOrReplace (collection, id, content, options = {}) {
    ...
    return this._storageEngine.createOrReplace(
      this.index,
      collection,
      id,
      content,
  ...
  replace (collection, id, content, options = {}) {
    ...
    return this._storageEngine.replace(
      this.index,
      collection,
      id,
      content,
  ...
  update (collection, id, content, options = {}) {
    ...
    return this._storageEngine.update(this.index, collection, id, content, opts);
  }
  ...
  delete (collection, id, options = {}) {
    ...
    return this._storageEngine.delete(this.index, collection, id, opts);
  }
}
