...
class NotifierController {
   ...
   * Lighter version of notifyDocumentMChanges, because
   * we do not need to 1st retrieve items from the
   * cache service
   *
   * @param {Request} request 
  ...
  //     this.cache.set(prefix + documents[i]._id, JSON.stringify(matchedRooms));
  //   }
  // }
