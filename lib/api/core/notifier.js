...
function NotifierController (kuzzle) {
  ...
  this.notifyDocumentCreate = function (requestObject, newDocument) {
    return kuzzle.services.list.notificationCache.search(requestObject.requestId)
      .then(rooms => {
        var notification = {
  ...
  this.notifyDocumentUpdate = function (requestObject) {
    ...
    return kuzzle.services.list.readEngine.get(new RequestObject(request))
      .then(result => {
  ...
  this.notifyDocumentDelete = function (requestObject, ids) {
    return Promise.each(ids, (id, callback) => {
      return kuzzle.services.list.notificationCache.search(id)
