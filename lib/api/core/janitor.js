...
class Janitor {
  ...
  dump (suffix) {
    if (this._dump) {
      return Bluebird.reject(errorsManager.get('internal', 'janitor', 'dump_already_generated'));
    }
    ...
    return new Bluebird((resolve, reject) => {
      ...
      fs.readdir(logDir, (err, files) => {
        if (err) {
          return reject(errorsManager.get('internal', 'janitor', 'reading_log_directory', logDir, err));
        }
