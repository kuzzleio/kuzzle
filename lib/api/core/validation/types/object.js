 ...
 * @returns {boolean}
 */
ObjectType.prototype.validate = function validate (typeOptions, fieldValue, errorMessages) {
 ...
 * @return {boolean}
 */
ObjectType.prototype.validateFieldSpecification = function validateFieldSpecification (typeOptions) {
 ...
 */
ObjectType.prototype.getStrictness = function getStrictness (typeOptions, parentStrictness) {
