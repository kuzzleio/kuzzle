 ...
 */
GeoShapeType.prototype.validate = function validate (typeOptions, fieldValue, errorMessages) {
 ...
 * @returns {boolean}
 */
GeoShapeType.prototype.recursiveShapeValidation = function recursiveShapeValidation (allowedShapes, shape, errorMessages) {
  var
 ...
 * @returns {boolean}
 */
GeoShapeType.prototype.checkStructure = function checkStructure (allowedShapes, shape, errorMessages) {
  var result = true;
 ...
 */
GeoShapeType.prototype.validateFieldSpecification = function validateFieldSpecification (typeOptions) {
