 ...
 */
GeoPointType.prototype.validate = function validate (typeOptions, fieldValue, errorMessages) {
  try {
 ...
 * @return {boolean}
 */
GeoPointType.prototype.validateFieldSpecification = function validateFieldSpecification () {
  return true;
};
