 ...
 */
DateType.prototype.validate = function validate (typeOptions, fieldValue, errorMessages) {
  var
    i,
    momentDate,
    valid = false,
 ...
 */
DateType.prototype.validateFieldSpecification = function validateFieldSpecification (typeOptions) {
  var
    min,
    max;
