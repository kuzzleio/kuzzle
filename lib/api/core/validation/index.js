...
Validation.prototype.init = function () {
  ...
  defaultTypesFiles.forEach(typeFile => {
...
Validation.prototype.curateCollectionSpecification = function (indexName, collectionName, collectionSpec, dryRun) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (collectionSpec.fields) {
      try {
        treatedSpecification.fields = this.structureCollectionValidation(indexName, collectionName, collectionSpec);
      }
      catch (error) {
        return reject(error);
      }
...
Validation.prototype.structureCollectionValidation = function (indexName, collectionName, collectionSpec) {
  var
    fields = {},
    maxDepth = 0;
