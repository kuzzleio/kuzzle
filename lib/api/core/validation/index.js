 ...
 */
Validation.prototype.validate = function validationValidate (requestObject) {
 ...
 */
Validation.prototype.validationPromise = function validationValidationPromise (requestObject, verbose) {
  var
  ...
  return new Promise(resolve => {
    ...
    if (collectionSpec) {
      ...
      if (collectionSpec.validators) {
        let filters = this.dsl.test(requestObject.index, requestObject.collection, documentBody, id)
 ...
 */
Validation.prototype.isValidSpecification = function validationIsValidSpecification (indexName, collectionName, collectionSpec) {
 ...
 */
Validation.prototype.curateCollectionSpecification = function validationCurateCollectionSpecification (indexName, collectionName, collectionSpec, dryRun) {
  dryRun = dryRun || false;
...
Validation.prototype.structureCollectionValidation = function validationStructureCollectionValidation (collectionSpec) {
  var
    fields = {},
    maxDepth = 0;
 ...
 */
Validation.prototype.curateFieldSpecification = function validationCurateFieldSpecification (fieldSpec) {
 ...
 * @throws InternalError
 */
Validation.prototype.curateFieldSpecificationFormat = function validationCurateFieldSpecificationFormat (fieldSpec) {
