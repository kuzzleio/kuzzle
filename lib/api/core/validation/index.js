  ...
  return new Promise((resolve, reject) => {
    ...
    if (this.specification && this.specification[index] && this.specification[index][collection]) {
      ...
      if (collectionSpec.fields) {
        ...
        if (!strictnessError && !validation && verbose) {
          manageErrorMessage('document', errorMessages, 'The document is not valid due to field validation.', verbose);
        }
      }
 ...
 * @param {boolean} verbose
 */
Validation.prototype.recurseFieldValidation = function (documentSubset, originalBodySubset, collectionSpecSubset, strictness, errorMessages, verbose) {
  if (strictness) {
