...
function importMapping() {
  ...
  try {
    ...
    deferred.reject(new Error('Error while loading the file ' + process.env.DEFAULT_MAPPING));
    return deferred.promise;
  }
...
function importFixtures() {
  ...
  try {
    ...
    deferred.reject(new Error('Error while reading the file ' + process.env.FIXTURES));
    return deferred.promise;
  }
