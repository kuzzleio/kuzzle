...
const nativeControllers = require('./controllers');
...
class Funnel {
  ...
  init () {
    global.kuzzle.on('kuzzle:shutdown', () => ( this.shuttingDown = true ));
    ...
    this.controllers.set('auth', new nativeControllers.Auth());
    this.controllers.set('bulk', new nativeControllers.Bulk());
    this.controllers.set('collection', new nativeControllers.Collection());
    this.controllers.set('document', new nativeControllers.Document());
    this.controllers.set('index', new nativeControllers.Index());
    this.controllers.set('realtime', new nativeControllers.Realtime());
    this.controllers.set('security', new nativeControllers.Security());
    this.controllers.set('server', new nativeControllers.Server());
    this.controllers.set('admin', new nativeControllers.Admin());

    const msController = new nativeControllers.MemoryStorage();
