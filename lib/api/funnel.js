...
class Funnel {
  ...
  processRequest (request) {
    ...
    return Bluebird.resolve()
      ...
      .then(responseData => {
        ...
        if ( !this.isNativeController(modifiedRequest.input.controller)
  ...
  handleProcessRequestError (modifiedRequest, request, error) {
    ...
    if (!this.isNativeController(request.input.controller) && !(error instanceof KuzzleError)) {
    ...
    return this.kuzzle.pipe(eventError, modifiedRequest)
      ...
      .catch(customError => {
        ...
        if (!this.isNativeController(request.input.controller)
