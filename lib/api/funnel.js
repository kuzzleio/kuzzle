            ...
            .then(modifiedRequest => {
              ...
              return this.checkRights(modifiedRequest)
                ...
                .then(processResult => {
                  ...
                  global.kuzzle.pipe('request:afterExecution', { request: _request, success: true, result: processResult })
                    .then(pipeEvent => {
                  ...
                  return global.kuzzle.pipe('request:afterExecution', { request: modifiedRequest, success: false, error: err })
