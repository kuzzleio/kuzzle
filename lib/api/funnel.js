...
class Funnel {
  ...
  execute (request, callback) {
    ...
    if (request.input.headers
      ...
      && !global.kuzzle.config.internal.allowAllOrigins
      && !httpConfig.accessControlAllowOrigin.includes(request.input.headers.origin) // If the domain is not present in the list
    ) {
