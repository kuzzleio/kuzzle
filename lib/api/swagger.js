...
module.exports = function generateSwagger () {
  ...
  global.kuzzle.config.http.routes.forEach(_route => routes.push(_.assign({}, _route)));
  global.kuzzle.pluginsManager.routes.forEach(_route => routes.push(_.assign({}, _route)));
