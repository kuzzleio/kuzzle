...
const countObject = readYamlFile('./lib/api/openapi/document/count.yaml');
...
// The yaml objects are then stored in the variables below
const createObject = readYamlFile('./lib/api/openapi/document/create.yaml');
...
// The yaml objects are then stored in the variables below
const createOrReplaceObject = readYamlFile('./lib/api/openapi/document/createOrReplace.yaml');
...
// The yaml objects are then stored in the variables below
const getObject = readYamlFile('./lib/api/openapi/document/get.yaml');
...
// The yaml objects are then stored in the variables below
const replaceObject = readYamlFile('./lib/api/openapi/document/replace.yaml');
...
// The yaml objects are then stored in the variables below
const existsObject = readYamlFile('./lib/api/openapi/document/exists.yaml');
...
// The yaml objects are then stored in the variables below
const updateObject = readYamlFile('./lib/api/openapi/document/update.yaml');
...
// The yaml objects are then stored in the variables below
const scrollObject = readYamlFile('./lib/api/openapi/document/scroll.yaml');
...
// The yaml objects are then stored in the variables below
const deleteObject = readYamlFile('./lib/api/openapi/document/delete.yaml');
...
// The yaml objects are then stored in the variables below
const deleteByQueryObject = readYamlFile('./lib/api/openapi/document/deleteByQuery.yaml');
