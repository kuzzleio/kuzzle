...
const routes = [
  ...
  { verb: 'get', path: '/:index/:collection/:_id', controller: 'document', action: 'get', openapi: DocumentGet },
  { verb: 'get', path: '/:index/:collection/_mGet', controller: 'document', action: 'mGet' },
  { verb: 'get', path: '/:index/:collection/:_id/_exists', controller: 'document', action: 'exists', openapi: DocumentExists },
  { verb: 'get', path: '/_scroll/:scrollId', controller: 'document', action: 'scroll', openapi: DocumentScroll },
  ...
  { verb: 'post', path: '/:index/:collection/_count', controller: 'document', action: 'count', openapi: DocumentCount },
  { verb: 'post', path: '/:index/:collection/_create', controller: 'document', action: 'create', openapi: DocumentCreate },
  ...
  { verb: 'delete', path: '/:index/:collection/:_id', controller: 'document', action: 'delete', openapi: DocumentDelete },
  { verb: 'delete', path: '/:index/:collection/:_id/_fields', controller: 'document', action: 'deleteFields' },
  { verb: 'delete', path: '/:index/:collection/_query', controller: 'document', action: 'deleteByQuery', openapi: DocumentDeleteByQuery },
  ...
  { verb: 'put', path: '/:index/:collection/:_id', controller: 'document', action: 'createOrReplace', openapi: DocumentCreateOrReplace },
  { verb: 'put', path: '/:index/:collection/_mCreateOrReplace', controller: 'document', action: 'mCreateOrReplace' },
  { verb: 'put', path: '/:index/:collection/:_id/_replace', controller: 'document', action: 'replace', openapi: DocumentReplace },
  ...
  { verb: 'put', path: '/:index/:collection/:_id/_update', controller: 'document', action: 'update', openapi: DocumentUpdate, deprecated: { since: '2.11.0', message: 'Use "document:update" route with PATCH instead of PUT' } }, // @deprecated
