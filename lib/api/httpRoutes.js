...
const routes = [
...

  {
    ...
    openapi: {
      description:
        "Creates a new API key for a user. The clear-text token is only ever returned in this response; it cannot be retrieved afterwards. If you are looking to manage your own API keys, use the `auth` controller instead.",
      parameters: [
        {
          in: "path",
          name: "userId",
        ...
        },
        {
          ...
          schema: { type: "string" },
          required: false,
          description: "API key unique ID (auto-generated if not provided)",
        },
        {
          in: "query",
          name: "expiresIn",
          ...
          required: false,
          description:
            "Expiration duration in milliseconds (-1 for no expiration)",
        },
        {
          in: "query",
          name: "refresh",
          ...
          required: false,
          description:
            "If set to `wait_for`, waits for the API key to be indexed before responding",
        },
      ],
      requestBody: {
        required: true,
      ...
      responses: {
        200: {
          description: "The created API key, including its clear-text token",
          content: {
            "application/json": {
              schema: {
                type: "object",
                properties: {
                  ...
                  _source: {
                    ...
                    properties: {
                      ...
                      fingerprint: {
                        type: "string",
                        description: "SHA256 hash of the token",
                      },
                      token: {
                        type: "string",
  ...
  },
  {
    ...
    openapi: {
      description:
        "Searches for a user's API keys. Supports the Elasticsearch Query DSL, or the Koncorde Filters DSL when `lang` is set to `koncorde`. If you are looking to manage your own API keys, use the `auth` controller instead.",
      parameters: [
        {
          in: "path",
          name: "userId",
        ...
        },
        {
          ...
          schema: {
            type: "string",
            enum: ["elasticsearch", "koncorde"],
            default: "elasticsearch",
          },
          required: false,
          description: "Query language used in the request body",
        },
      ],
      requestBody: {
        required: false,
        content: {
          "application/json": {
            schema: {
              type: "object",
              description:
                "Search query (Elasticsearch Query DSL or Koncorde filters). Leave empty to match all of the user's API keys.",
            },
          },
        },
      },
...

  {
    ...
    openapi: {
      description:
        "Deletes a user API key, identified by its `_id`. If you are looking to manage your own API keys, use the `auth` controller instead.",
      parameters: [
        {
          in: "path",
          name: "userId",
        ...
        },
        {
          ...
          required: false,
          description:
            "If set to `wait_for`, waits for the deletion to be indexed before responding",
        },
      ],
      responses: {
        200: {
          description: "The deleted API key ID",
          content: {
            "application/json": {
              schema: {
                type: "object",
  ...
  },
  {
    ...
    openapi: {
      description:
        "Deletes a user API key, identified by its clear-text `key` or its `fingerprint` instead of its `_id`. Exactly one of `key` or `fingerprint` must be provided. If you are looking to manage your own API keys, use the `auth` controller instead.",
      parameters: [
        {
          in: "path",
          name: "userId",
        ...
        },
        {
          ...
          schema: { type: "string" },
          required: false,
          description: "Clear-text API key to delete",
        },
        {
          in: "query",
          name: "fingerprint",
          schema: { type: "string" },
          required: false,
          description: "SHA256 fingerprint of the API key to delete",
        },
        {
          in: "query",
          name: "refresh",
