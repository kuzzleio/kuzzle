...
module.exports = function RouterController (kuzzle) {
  ...
  this.initRouterHttp = function () {
    ...
    apiBase.get('/swagger.json', (request, response) => {
      var content;
      try {
        content = fs.readFileSync(__dirname + '/../../../kuzzle-swagger.json');
      }
      catch (e) {
        content = stringify({error: 'The swagger file has not been generated. Use the `kuzzle swagger` CLI command to generate it.', status: 500});
      }
      response.writeHead('Access-Control-Allow-Origin', '*');
      response.writeHead('Access-Control-Allow-Headers', 'X-Requested-With');
      response.writeHead(200, {'Content-Type': 'application/json'});
    ...
    apiBase.get('/swagger.yml', (request, response) => {
      var content;
      try {
        content = fs.readFileSync(__dirname + '/../../../kuzzle-swagger.yml');
      }
      catch (e) {
        content = '  error: "The swagger file has not been generated. Use the `kuzzle swagger` CLI command to generate it."\n  status: 500';
      }
      response.writeHead('Access-Control-Allow-Origin', '*');
      response.writeHead('Access-Control-Allow-Headers', 'X-Requested-With');
