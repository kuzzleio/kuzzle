...
module.exports = function RouterController (kuzzle) {
  ...
  this.initRouterHttp = function () {
    ...
    routes = [
      ...
      {verb: 'get', url: '/profiles/:id/_policies', controller: 'security', action: 'getProfilePolicies'},
      ...
      {verb: 'get', url: '/users/_me/_policies', controller: 'auth', action: 'getCurrentUserPolicies'},
      {verb: 'get', url: '/users/:id', controller: 'security', action: 'getUser'},
      {verb: 'get', url: '/users/:id/_policies', controller: 'security', action: 'getUserPolicies'},
