...
module.exports = function RouterController (kuzzle) {
  ...
  this.initRouterHttp = function () {
    ...
    apiBase.get('/swagger.json', (request, response) => {
      ...
      fs.readFile(__dirname + '/../../../kuzzle-swagger.json', (err, data) => {
        if (err) {
          response.writeHead(500, {'Content-Type': 'application/json'});
          reponse.end(JSON.stringify({error: 'The swagger file has not been generated. Use the `kuzzle swagger` CLI command to generate it.', status: 500}))
        }
    ...
    apiBase.get('/swagger.yml', (request, response) => {
      ...
      fs.readFile(__dirname + '/../../../kuzzle-swagger.yml', (err, data) => {
        if (err) {
          response.writeHead(500, {'Content-Type': 'application/yaml'});
          reponse.end(JSON.stringify({error: 'The swagger file has not been generated. Use the `kuzzle swagger` CLI command to generate it.', status: 500}))
        }
