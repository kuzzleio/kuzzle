...
class ServerController extends BaseController {
  ...
  healthCheck(request) {
    ...
    return this.kuzzle.cacheEngine.internal.infos()
      .then(() => {
        result.cacheEngine.internal = 'green';
      })
      .catch(error => {
        request.setError(errorsManager.getError(
          ...
          'service_unavailable',
          error));
        result.cacheEngine.internal = 'red';
        result.status = 'red';
      })
      .then(() => this.kuzzle.cacheEngine.public.infos())
      .then(() => {
      ...
      .then(() => this.kuzzle.storageEngine.public.infos())
      .then(response => {
