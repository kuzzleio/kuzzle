...
class ServerController extends BaseController {
  ...
  info() {
    ...
    ['controllers', 'pluginsControllers'].forEach(controllers => {
      ...
      Object.keys(this.kuzzle.funnel[controllers]).forEach(controller => {
          ...
          properties.push(
            ...Object.getOwnPropertyNames(
              Object.getPrototypeOf(
                this.kuzzle.funnel[controllers][controller]
              ))
        ...
        properties.push(...Object.keys(
          ...
          p =>
            this.kuzzle.funnel[controllers][controller].hasOwnProperty(p)
        ));
    ...
    return Object.keys(this.kuzzle.services.list).reduce(
      (previous, current) => {
