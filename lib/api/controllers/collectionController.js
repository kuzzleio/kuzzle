...
function CollectionController (kuzzle) {
  ...
  this.getSpecifications = function collectionGetSpecifications (request) {
    assertHasIndexAndCollection(request, 'collection:getSpecifications');
  ...
  this.updateSpecifications = function collectionUpdateSpecifications (request) {
    ...
    return validateGivenSpecifications(request, kuzzle, true)
      .then(response => {
        var
          promises = [],
          error;
  ...
  this.validateSpecifications = function collectionValidateSpecifications (request) {
    ...
    return validateGivenSpecifications(request, kuzzle);
  };
 ...
 * @param {Request} request
 * @param {Kuzzle} kuzzle
 * @param {boolean} returnSpecifications
 * @returns {Promise}
 */
function validateGivenSpecifications(request, kuzzle, returnSpecifications) {
  var specifications = [];

  returnSpecifications = returnSpecifications || false;
  ...
  return createSpecificationList(request)
    ...
    .then(result => {
      if (result.valid && returnSpecifications) {
