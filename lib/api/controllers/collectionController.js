...
class CollectionController extends BaseController {
  constructor(kuzzle) {
    ...
    this.engine = kuzzle.services.publicStorage;
  }
  ...
  updateMapping(request) {
    ...
    // @todo indexCache exists + add in controller
  ...
  searchSpecifications(request) {
    ...
    return this.kuzzle.internalIndex.search('validations', query, request.input.args);
  }
  ...
  scrollSpecifications(request) {
    ...
    return this.kuzzle.internalIndex.scroll(
      'validations',
      ...
      .then(response => {
        if (response.valid) {
          ...
          specifications.forEach(specification => {
            ...
            promises.push(this.kuzzle.internalIndex.createOrReplace(
              'validations',
              specification._id,
        ...
        const error = errorsManager.get('update_specifications', response.description);
        error.details = response.details;
        throw error;
      })
      .then(() => this.kuzzle.internalIndex.refresh())
  ...
  deleteSpecifications(request) {
    ...
    return this.kuzzle.internalIndex.delete(
      'validations',
