...
class CollectionController extends NativeController {
  ...
  async updateMapping(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] updated mapping for collection "${index}#${collection}"`,
    );
  ...
  async updateSpecifications(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] updated specifications for collection "${index}#${collection}" new specifications: ${JSON.stringify(specifications)}`,
    );
  ...
  async deleteSpecifications(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] deleted specifications for collection "${index}#${collection}"`,
    );
  ...
  async truncate(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] truncated collection "${index}#${collection}"`,
    );
  ...
  async create(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] created collection "${index}#${collection}"`,
    );
  ...
  async update(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] updated collection "${index}#${collection}"`,
    );
  ...
  async delete(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] deleted collection "${index}#${collection}"`,
    );
