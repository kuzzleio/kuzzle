 ...
 * Default to true for loadXXX actions.
 *
 * @param {Request} request
 *
 * @returns {String}
 */
function getWaitForRefresh (request) {
...
class AdminController extends NativeController {
  ...
  loadFixtures (request) {
    ...
    const waitForRefresh = getWaitForRefresh(request);
  ...
  async loadSecurities (request) {
    ...
    const promise = this.kuzzle.janitor.loadSecurities(securities, { force, user });
