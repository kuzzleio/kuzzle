...
/**
 * @class AbstractSecurityController providing generic functions.
 * Currently used by SecurityController and UserController
 */
class AbstractSecurityController extends NativeController {
  constructor (actions = []) {
    super(actions);
...
module.exports = AbstractSecurityController;
