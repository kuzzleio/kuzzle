...
class BaseController {
  ...
  _getBoolean (obj, protocol, name, errorName) {
    ...
    if (protocol === 'http') {
      ...
      assertionError.throw('invalid_type', errorName, 'boolean');
    }
    else {
      value = Boolean(value);
    }
  ...
  _getNumber (obj, name, errorName, def = null) {
    ...
    if (Number.isNaN(value)) {
      assertionError.throw('invalid_type', errorName, 'number');
    }
  ...
  _getInteger (obj, name, errorName, def = null) {
    ...
    if (Number.isNaN(value) || !Number.isSafeInteger(value)) {
      assertionError.throw('invalid_type', errorName, 'integer');
    }
  ...
  _getString (obj, name, errorName, def = null) {
    ...
    if (typeof value !== 'string') {
      assertionError.throw('invalid_type', errorName, 'string');
    }
  ...
  _getArray (obj, name, errorName, def = null) {
    ...
    if (!Array.isArray(value)) {
      assertionError.throw('invalid_type', errorName, 'array');
    }
  ...
  _getObject (obj, name, errorName, def = null) {
    ...
    if (value === null || typeof value !== 'object' || Array.isArray(value)) {
      assertionError.throw('invalid_type', errorName, 'object');
    }
  ...
  /**
   * Returns an array of ids specified in the request
   *
   * @param {Request} request
   *
   * @throws
  ...
  getIds(request) {
    const id = [];
    id.push(request.input.resource._id);
    // if (!id) {
    //   assertionError.throw('missing_argument', '_id');
    // }
