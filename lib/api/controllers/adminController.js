...
function AdminController(kuzzle) {
   ...
   * @returns {Promise}
   */
  this.updateUserMapping = function adminUpdateUserMapping (request) {
   ...
   * @returns {Promise}
   */
  this.getUserMapping = function adminGetUserMapping () {
  ...
  this.updateSpecifications = function adminUpdateSpecifications (request) {
    assertHadBody(request, 'updateSpecifications');
  ...
  /**
   * Delete a specification collection
   *
   * @param {Request} request
   * @returns {Promise<Object>}
   */
  this.deleteSpecifications = function adminDeleteSpecifications (request) {
    assertHasIndexAndCollection(request, 'deleteSpecifications');
  ...
  this.validateSpecifications = function adminValidateSpecifications (request) {
    assertHadBody(request, 'validateSpecifications');
   ...
   * @returns {Promise<Object>}
   */
  this.getAllStats = function adminGetAllStats () {
  ...
  this.truncateCollection = function adminTruncateCollection (request) {
    assertHasIndexAndCollection(request, 'truncateCollection');
  ...
  this.deleteIndexes = function adminDeleteIndexes (request) {
    ...
    assertHadBody(request, 'deleteIndexes');
    assertBodyHasAttribute(request, 'indexes', 'deleteIndexes');
  ...
  this.createIndex = function adminCreateIndex (request) {
    assertHasIndex(request, 'createIndex');
  ...
  this.deleteIndex = function adminDeleteIndex (request) {
    assertHasIndex(request, 'deleteIndex');
  ...
  this.removeRooms = function adminRemoveRooms (request) {
    assertHasIndexAndCollection(request, 'removeRooms');
  ...
  this.refreshIndex = function adminRefreshIndex (request) {
    assertHasIndex(request, 'refreshIndex');
  ...
  this.getAutoRefresh = function adminGetAutoRefresh (request) {
    assertHasIndex(request, 'getAutoRefresh');
  ...
  this.setAutoRefresh = function adminSetAutoRefresh (request) {
    assertHadBody(request, 'setAutoRefresh');
    assertBodyHasAttribute(request, 'autoRefresh', 'setAutoRefresh');
  ...
  this.createFirstAdmin = function adminCreateFirstAdmin (request) {
    ...
    assertHadBody(request, 'createFirstAdmin');
