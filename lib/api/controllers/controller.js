...
class BaseController {
  ...
  tryGetBoolean (request, flagPath) {
    ...
    if (request.context.connection.protocol !== 'http'
      ...
      throw new BadRequestError(`Invalid '${flagName}' value (${flagValue}): boolean expected`);
  ...
  throw(...args) {
    ...
    this.kuzzle.throw(this.domain, this.subdomain, ...args);
  }
  ...
  getError(...args) {
    ...
    return this.kuzzle.getError(this.domain, this.subdomain, ...args);
  }
}
