...
function AuthController (kuzzle) {
   ...
   * @returns {Promise}
   */
  this.logout = function authLogout (requestObject, context) {
   ...
   * @returns {Promise}
   */
  this.login = function authLogin (requestObject, context) {
    var
   ...
   * @returns {Promise}
   */
  this.getCurrentUser = function authGetCurrentUser (requestObject, context) {
   ...
   * @returns {Promise}
   */
  this.getMyRights = function getMyRights (requestObject, context) {
    requestObject.data._id = context.token.userId;
   ...
   * @param requestObject
   */
  this.checkToken = function authCheckToken (requestObject) {
   ...
   * @returns {Promise}
   */
  this.updateSelf = function authUpdateSelf (requestObject, context) {
