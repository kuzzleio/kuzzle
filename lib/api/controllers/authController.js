...
class AuthController {
  ...
  createMyCredentials(request) {
    ...
    return createMethod(request, request.input.body, request.context.user._id);
  }
  ...
  updateMyCredentials(request) {
    ...
    return updateMethod(request, request.input.body, request.context.user._id);
  }
