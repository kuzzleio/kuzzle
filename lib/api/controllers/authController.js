...
const
  ...
  { UnauthorizedError, InternalError: KuzzleInternalError } = require('kuzzle-common-objects').errors,
  {assertHasBody, assertBodyHasNotAttribute, assertBodyHasAttribute} = require('./util/requestAssertions');
