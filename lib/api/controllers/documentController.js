...
class DocumentController extends NativeController {
  ...
  async create(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] created document "${id}" in "${index}#${collection}"`,
    );
  ...
  async createOrReplace(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] created/replaced document "${id}" in "${index}#${collection}"`,
    );
  ...
  async update(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] updated document "${id}" in "${index}#${collection}"`,
    );
  ...
  async upsert(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] created/updated document "${id}" in "${index}#${collection}"`,
    );
  ...
  async replace(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] replaced document "${id}" in "${index}#${collection}"`,
    );
  ...
  async delete(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] deleted document "${id}" from "${index}#${collection}"`,
    );
  ...
  async deleteByQuery(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] deleted ${result.documents.length} documents from "${index}#${collection}" by query`,
    );
  ...
  async deleteFields(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] deleted fields from document "${id}" in "${index}#${collection}"`,
    );
  ...
  async updateByQuery(request) {
    ...
    global.kuzzle.log.info(
      `[STORAGE] updated ${result.successes.length} documents in "${index}#${collection}" by query`,
    );
