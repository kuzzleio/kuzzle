...
const BufferedPassThrough = require('../../util/bufferedPassThrough');
const { dumpCollectionData } = require('../../util/dump-collection');
/**
...
class DocumentController extends NativeController {
  ...
  async export (request) {
    ...
    const stream = new BufferedPassThrough({ highWaterMark: 16384 });
