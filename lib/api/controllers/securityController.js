...
module.exports = function SecurityController (kuzzle) {
  ...
  this.getRole = function (requestObject) {
    var roleRequest = kuzzle.repositories.role.getRoleFromRequestObject(requestObject);
    ...
    return kuzzle.repositories.role.loadRole(roleRequest)
      .then(role => {
        ...
        return new ResponseObject(requestObject, formatRoleForSerialization(role));
      })
  ...
  this.getProfile = function (requestObject) {
    ...
    return kuzzle.repositories.profile.buildProfileFromRequestObject(requestObject)
      ...
      .then(profile => {
        ...
        return new ResponseObject(requestObject, formatProfileForSerialization(profile, true));
      })
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
  ...
  this.createOrReplaceProfile = function (requestObject, context) {
    ...
    return createOrReplaceProfile.call(kuzzle, requestObject, context, {method: 'createOrReplace'})
      .then(profile => new ResponseObject(requestObject, formatProfileForSerialization(profile)))
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
  ...
  this.getUser = function (requestObject) {
    ...
    if (!requestObject.data._id) {
      return q.reject(new ResponseObject(requestObject, new BadRequestError('No user id given')));
    }
  ...
  this.searchUsers = function (requestObject) {
    ...
    return kuzzle.repositories.user.search(
      ...
      .then(formattedUsers => new ResponseObject(requestObject, {hits: formattedUsers, total: formattedUsers.length}))
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
    ...
    return kuzzle.pluginsManager.trigger('security:createUser', requestObject)
      .then(newRequestObject => {
        ...
        return kuzzle.repositories.user.hydrate(user, pojoUser)
          ...
          .then(u => {
            return formatUserForSerialization(u, true);
          })
          .then(serializedUser => {
            return new ResponseObject(requestObject, serializedUser)
          });
      })
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
  ...
  this.updateProfile = function (requestObject, context) {
    ...
    return kuzzle.pluginsManager.trigger('security:updateProfile', requestObject)
      ...
      .then(updatedProfile => new ResponseObject(newRequestObject, formatProfileForSerialization(updatedProfile, true)))
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
    ...
    return kuzzle.pluginsManager.trigger('security:updateRole', requestObject)
      .then(newRequestObject => {
        ...
        return kuzzle.repositories.role.loadRole(
          ...
          .then(updatedRole => new ResponseObject(newRequestObject, formatRoleForSerialization(updatedRole)));
      })
      .catch(err => q.reject(new ResponseObject(requestObject, err)));
  };
