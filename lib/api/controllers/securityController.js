...
class SecurityController {
  ...
  createCredentials(request) {
    ...
    return createMethod(request, request.input.body, request.input.resource._id);
  }
  ...
  updateCredentials(request) {
    ...
    return updateMethod(request, request.input.body, request.input.resource._id);
  }
...
function createUser (kuzzle, request, restricted) {
  ...
  if (restricted && request.input.body.content.profileIds) {
