...
var createOrReplaceRole = function (requestObject, context, opts) {
  this.pluginsManager.trigger('security:createRole', requestObject);
...
var createOrReplaceProfile = function (requestObject, context, opts) {
  this.pluginsManager.trigger('security:createProfile', requestObject);
