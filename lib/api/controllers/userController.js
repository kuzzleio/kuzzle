...
class UserController extends NativeSecurityController {
   ...
   * @private
   */
  async _persist (request, profileIds, content, { humanReadableId = true } = {}) {
  ...
  async create (request) {
    ...
    return this._persist(request, profileIds, content, { humanReadableId });
  }
  ...
  async createFirstAdmin (request) {
    ...
    const user = await this._persist(request, [ 'admin' ], content, { humanReadableId });
