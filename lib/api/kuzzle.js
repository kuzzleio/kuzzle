...
class Kuzzle extends EventEmitter {
  ...
  start (params = {}) {
    ...
    const internalBootstrap = new InternalBootstrap(this, this.internalEngine);

    return this.internalEngine.init(internalBootstrap)
      .then(() => this.internalEngine.bootstrap.startOrWait())
      .then(() => {
