...
const
  ...
  InternalStorage = require('../api/core/internalStorage'),
  Validation = require('./core/validation'),
  InternalBootstrap = require('../services/bootstrap/internalBootstrap'),
...
class Kuzzle extends EventEmitter {
  constructor() {
    ...
    this.internalStorage =
      new Elasticsearch(this, this.config.services.db, 'internal');
  ...
  start (params = {}) {
    ...
    const internalBootstrap = new InternalBootstrap(this, this.internalStorage);

    return this.internalStorage.init(internalBootstrap)
      .then(() => this.internalStorage.bootstrap.startOrWait())
      .then(() => {
