...
class AuthController extends NativeController {
   ...
   */
  getMyRights (request) {
    request.addDeprecation('2.4.0', 'http://kuzzle:7512/users/_me/_rights as been replaced by http://kuzzle:7512/_me/_rights');
  ...
  async updateSelf (request) {
    request.addDeprecation('2.4.0', 'http://kuzzle:7512/_updateSelf as been replaced by http://kuzzle:7512/_me');
    this.assertIsAuthenticated(request);
  ...
  updateMyCredentials (request) {
    request.addDeprecation('2.4.0', 'http://kuzzle:7512/credentials/<strategy>/_me/_update as been replaced by http://kuzzle:7512/_me/credentials/<strategy>/_update');
    this.assertIsAuthenticated(request);
  ...
  credentialsExist (request) {
    request.addDeprecation('2.4.0', 'http://kuzzle:7512/credentials/<strategy>/_me/_exists as been replaced by http://kuzzle:7512/_me/credentials/<strategy>/_exists');
    this.assertIsAuthenticated(request);
