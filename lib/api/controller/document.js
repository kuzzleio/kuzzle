...
class DocumentController extends NativeController {
  ...
  exists (request) {
    ...
    return this.ask('core:store:public:document:exist', index, collection, id);
  }
  ...
  mGet (request) {
    ...
    return this.ask('core:store:public:document:mGet', index, collection, ids)
      .then(({ items, errors }) => {
        return {
          errors,
          successes: items
  ...
  async delete (request) {
    ...
    await this.ask('core:store:public:document:delete', index, collection, id, {
      refresh,
    });
  ...
  async _mChanges (request, methodName, action) {
    ...
    const response = await this.ask(
      `core:store:public:document:${methodName}`,
      index,
      collection,
      documents,
      { refresh, userId });
