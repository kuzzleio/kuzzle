 ...
 */
OperandsRemoval.prototype.exists = function exists (foPairs, index, collection, subfilter, condition, keyword = 'exists') {
  var
    operand,
 ...
 * @param {string} [keyword]
 */
OperandsRemoval.prototype.regexp = function regexp (foPairs, index, collection, subfilter, condition, keyword = 'regexp') {
  var
    fieldName = Object.keys(condition.value)[0],
...
OperandsRemoval.prototype.notgeospatial = function notgeospatial (foPairs, index, collection, subfilter, condition) {
  ...
  if (operand.fields[fieldName].ids.array[idx].subfilters.length > 1) {
