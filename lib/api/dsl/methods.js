...
function Methods(filtersObject) {
   ...
   */
  this.equals = function methodsEquals (roomId, index, collection, filter, not) {
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.in = function methodsIn (roomId, index, collection, filter, not) {
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.range = function methodsRange (roomId, index, collection, filter, not) {
    var
      diff = [],
      field,
      formattedFilters;
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.bool = function methodsBool (roomId, index, collection, filter, not) {
    var
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.must = function methodsMust (roomId, index, collection, filters, not) {
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.mustNot = function methodsMustNot (roomId, index, collection, filters, not) {
    if (not === undefined) {
      not = false;
    }
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.should = function methodsShould (roomId, index, collection, filters, not) {
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.shouldNot = function methodsShouldNot (roomId, index, collection, filters, not) {
    if (not === undefined) {
      not = false;
    }
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.or = function methodsOr (roomId, index, collection, filters, not) {
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.not = function methodsNot (roomId, index, collection, filters, not) {
    if (not === undefined) {
      not = false;
    }
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.exists = function methodsExists (roomId, index, collection, filter, not) {
    var
      fieldName,
      formattedFilters,
      encodedFunctionName,
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.ids = function methodsIds (roomId, index, collection, filter, not) {
    var
      formattedFilters,
      encodedFunctionName,
      result;
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.geoBoundingBox = function methodsGeoBoundingBox (roomId, index, collection, filter, not) {
    var
      encodedFunctionName,
      fieldName,
      formattedFilters = {},
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.geoDistance = function methodsGeoDistance (roomId, index, collection, filter, not) {
    var
      encodedFunctionName,
      fieldName,
      formattedFilters = {},
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.geoDistanceRange = function methodsGeoDistanceRange (roomId, index, collection, filter, not) {
    var
      encodedFunctionName,
      fieldName,
      formattedFilters = {},
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.geoPolygon = function methodsGeoPolygon (roomId, index, collection, filter, not) {
    var
      encodedFunctionName,
      fieldName,
      formattedFilters = {},
   ...
   */
  this.geoShape = function methodsGeoShape () {
   ...
   */
  this.regexp = function methodsRegexp (roomId, index, collection, filter, not) {
    var
      encodedFunctionName,
      field,
      value,
   ...
   * @return {Promise} the formatted filter that need to be added to the room
   */
  this.missing = function methodsMissing (roomId, index, collection, filter, not) {
    var
      fieldName,
      formattedFilters,
      encodedFunctionName,
