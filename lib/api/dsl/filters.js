...
function Filters () {
   ...
   */
  this.addSubscription = function filtersAddSubscription (filterId, index, collection, filters) {
    var
      filterName,
      privateFilterName;
   ...
   * @returns {Promise}
   */
  this.addCollectionSubscription = function filtersAddCollectionSubscription (filterId, index, collection) {
    var 
      changed = false,
      diff = {ftG: {
        i: index,
   ...
   */
  this.add = function filtersAdd (index, collection, field, operator, value, encodedFunctionName, filterId, not, inGlobals) {
    var
   ...
   */
  this.testFieldFilters = function filtersTestFieldFilters (index, collection, flattenBody, cachedResults) {
    var
      matchedIds = [],
      documentKeys = [];
   ...
   */
  this.testGlobalsFilters = function filtersTestGlobalsFilters (index, collection, flattenBody, cachedResults) {
    /*
   ...
   * @param {string} filterId
   */
  this.removeFilter = function filtersRemoveFilter (filterId) {
   ...
   * @returns {Array} Array of matching filter IDs
   */
  this.getFilterIds = function filtersGetFilterIds (index, collection) {
    var
      ids = [],
      linkTree;
