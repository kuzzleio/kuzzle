...
module.exports = operators = {
   ...
   *
   * @param {String} field the field that we have to check
   * @param {String|{lat: *, lon: *}|{from: *, to: *}} value containing the bounding box coords
   ...
   *
   * @param {String} field the field that we have to check
   * @param {String|{lat: *, lon: *}|{from: *, to: *}} value containing the coordinates from which to calculate the distance and the distance
   * @param {Object} document the document sent by user that we have to test
