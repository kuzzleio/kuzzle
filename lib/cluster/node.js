...
class ClusterNode {
  ...
  onIndexAdded (scope, index) {
    this.publisher.sendIndexAdded(scope, index);
  }
  ...
  onCollectionAdded (scope, index, collection) {
    this.publisher.sendCollectionAdded(scope, index, collection);
  }
  ...
  onIndexesRemoved (scope, indexes) {
    this.publisher.sendIndexesRemoved(scope, indexes);
  }
  ...
  onCollectionRemoved (scope, index, collection) {
    this.publisher.sendCollectionRemoved(scope, index, collection);
  }
