...
class ClusterSubscriber {
  ...
  handleNewRealtimeRoom (message) {
    ...
    this.localNode.state.addRealtimeRoom(roomId, index, collection, filters, {
  ...
  handleSubscription (message) {
    this.localNode.state.addRealtimeSubscription(
      message.roomId,
      this.remoteNodeId,
      message.messageId);
  }
  ...
  handleRealtimeRoomRemoval (message) {
    this.localNode.state.removeRealtimeRoom(message.roomId, this.remoteNodeId);
  }
  ...
  handleUnsubscription (message) {
    this.localNode.state.removeRealtimeSubscription(
      message.roomId,
      this.remoteNodeId,
      message.messageId);
  }
