...
class ClusterSubscriber {
  ...
  handleAuthStrategyRemoval (message) {
    ...
    this.kuzzle.pluginsManager.unregisterStrategy (pluginName, strategyName);
  ...
  handleDumpRequest (message) {
    ...
    this.kuzzle.janitor.dump(message.suffix);
  }
  ...
  async handleProfileInvalidation (message) {
    ...
    await this.kuzzle.ask('core:security:profile:invalidate', message.profileId);
  }
  ...
  async handleRoleInvalidation (message) {
    ...
    await this.kuzzle.ask('core:security:role:invalidate', message.roleId);
  }
