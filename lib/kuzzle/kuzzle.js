...
class Kuzzle extends KuzzleEventEmitter {
  ...
  async start (options = {}) {
    ...
    try {
      this.log.info(`[ℹ] Starting Kuzzle ${require('../../package.json').version} ...`);
      ...
      this.pluginsManager.application = options.application;
      await this.pluginsManager.init(options.additionalPlugins);
      this.log.info(`[✔] Successfully loaded ${this.pluginsManager.plugins.length} plugins: ${this.pluginsManager.plugins.join(', ')}`);
