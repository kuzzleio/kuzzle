...
class Kuzzle extends KuzzleEventEmitter {
  ...
  async start (params = {}) {
    ...
    try {
      ...
      // We need to init the internal protocol before so plugin can register
      // realtime subscription in the init() method
      this.entryPoint.protocols.internal.init(this.entryPoint);
