...
const
  ...
  ESCommon = require('../util/esCommon'),
...
class ElasticSearch extends Service {
  ...
  getInfos() {
    ...
    return this.client.info()
      ...
      .catch(error => Bluebird.reject(ESCommon.formatESError(error)));
  }
    ...
    return getAllIdsFromQuery(this.client, esRequestSearch)
      .then(ids => {
        return new Bluebird((resolve, reject) => {
          ...
          return this.client.bulk(esRequestBulk)
            .then(() => this.refreshIndexIfNeeded(esRequestBulk, {ids}))
            .catch(error => reject(ESCommon.formatESError(error)));
        });
      });
  }
  ...
  import(request) {
    ...
    return this.client.bulk(esRequest)
      ...
      .catch(err => Bluebird.reject(ESCommon.formatESError(err)));
  }
