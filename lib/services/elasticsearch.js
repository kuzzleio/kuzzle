...
class ElasticSearch extends Service {
  ...
  _mergeDefaultMapping (index, oldMapping, newMapping) {
    ...
    const commonMapping = this.kuzzle.indexCache.defaultMappings[index] || this.config.commonMapping;
    ...
    // Inject kuzzle meta but preserve existing ones
    if (oldMapping.properties && oldMapping.properties._kuzzle_info) {
      Object.assign(
        commonMapping._kuzzle_info,
        oldMapping.properties._kuzzle_info
      );
    }
