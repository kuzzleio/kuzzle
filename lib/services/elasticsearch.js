...
class ElasticSearch extends Service {
  ...
  * @param {Object} options - from (undefined), size (undefined), refresh (undefined)
  *
  * @returns {Promise.<Object>} { documents, total, updated, failures: [ _shardId, reason ] }
  */
  async updateByQuery(
    index,
    collection,
    ...
    { refresh, from, size = 1000 } = {})
  {
    ...
    try {
      let documents = await this._getAllDocumentsFromQuery(esRequest);
