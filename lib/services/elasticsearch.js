...
class ElasticSearch extends Service {
  ...
  * @param {Object} options - from (undefined), size (undefined), refresh (undefined), timeout (undefined), userId (undefined)
  *
  * @returns {Promise.<Object>} { documents, total, failures: [ _shardId, reason ] }
  */
  async updateByQuery(
    index,
    collection,
