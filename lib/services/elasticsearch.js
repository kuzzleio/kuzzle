...
class ElasticSearch extends Service {
  ...
  getMapping(request) {
    ...
    } else if (request.context.connection.protocol !== 'http' && request.input.args.includeKuzzleInfo !== undefined) {
      includeKuzzleInfo = request.input.args.includeKuzzleInfo;
    } else {
      includeKuzzleInfo = request.input.args.includeKuzzleInfo !== undefined ? true : false;
    }
