...
class ElasticSearch extends Service {
  ...
  get(request) {
    ...
    if (esRequest.id === '_search') {
      return Bluebird.reject(this.get('wrong_get_action'));
    }
    ...
    return this.client.get(esRequest)
      .then(result => {
        if (
          ...
          return Bluebird.reject(this.get('document_not_found'));
        }
        ...
        if (esRequest.id) {
          ...
          return this.client.get(
            ...
            .then(result => {
              ...
              return Bluebird.reject(this.get('document_already_exists'));
            })
  ...
  replace(request) {
    ...
    return this.kuzzle.indexCache.exists(esRequest.index, esRequest.type)
      ...
      .then(exist => {
        ...
        return Bluebird.reject(this.get(
  ...
  deleteByQuery(request) {
    ...
    if (!esRequestSearch.body.query ||
      ...
      return Bluebird.reject(this.get('empty_query'));
    }
  ...
  deleteByQueryFromTrash(request) {
    ...
    if (esRequestSearch.body.query === null) {
      return Bluebird.reject(this.get('document_id_cannot_be_null'));
    }
  ...
  import(request) {
    ...
    if (!request.input.body || !(request.input.body.bulkData instanceof Object)) {
      return Bluebird.reject(
        this.get('missing_or_invalid_import_attribute')
      );
    }
