module.exports = function (kuzzle) {
   ...
   */
  this.init = function () {
    this.uniquetaskQueue = this.kuzzle.config.queues.enableServicesQueue + '-' + process.pid;

    this.kuzzle.services.list.broker.listen(this.kuzzle.config.queues.enableServicesQueue, onListenCB.bind(this));
