      ...
      clientConnect.call(this)
        .then(function (ws) {
          /*
           ...
           because the client will try to re-register every known listeners when a connection has been established.
            */
...
function clientConnect() {
  ...
  this.client.socket.on('open', function () {
    ...
    /*
    Re-register all known listeners. Allow to cleanly restore the previous client state in case we temporarily
    lose the connection to the server.
     */
