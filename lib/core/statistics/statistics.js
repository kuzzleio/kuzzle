...
class Statistics {
  constructor() {
    ...
    this.ttl = this.kuzzle.config.stats.ttl * 1000;
    this.interval = this.kuzzle.config.stats.statsInterval * 1000;
    this.lastFrame = null;
    this.timer = null;
   ...
   */
  init () {
    this.timer = setInterval(() => this.writeStats(), this.interval);
    this.kuzzle.on('core:cache:internal:flushdb', () => {
      this.lastFrame = null;
    });
  }
