      ...
      Reflect.defineProperty(this, controllerName, {
        get: () => {
          ...
          if (! this[controllerProxy]) {
            ...
            // Create a proxy object to injects our local 'query' behaviour
            ...
            this[controllerProxy] = new Proxy(global.app.sdk[controllerName], {
              get: (controllerInstance, actionName) => {
                ...
                // Return the original SDK action method BUT bind to this local context
                // with our custom 'query method
                return controllerInstance[actionName].bind({
                  query: (request, opts) => {
