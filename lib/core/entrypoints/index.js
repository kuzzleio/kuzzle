  ...
  loadMoreProtocols () {
    ...
    return Bluebird.map(dirs, protoDir => {
      ...
      return Bluebird.resolve()
        ...
        .timeout(initTimeout, `Protocol "${manifest.name}" initialization timed out after ${initTimeout}. Try to increase the configuration "services.common.defaultInitTimeout".`)
        .then(() => {
