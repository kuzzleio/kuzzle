...
class ClientAdapter {
  ...
  async createIndex (
    ...
    options.indexCacheOnly = options.indexCacheOnly !== undefined
      ? options.indexCacheOnly
      : false;
    options.propagate = options.propagate !== undefined
      ? options.propagate
      : true;
  ...
  async createCollection (
    ...
    creationOptions.indexCacheOnly = creationOptions.indexCacheOnly !== undefined
      ? creationOptions.indexCacheOnly
      : false;
    creationOptions.propagate = creationOptions.propagate !== undefined
      ? creationOptions.propagate
      : true;

    if (! creationOptions.indexCacheOnly) {
      await this.client.createCollection(index, collection, opts);
    }

    this.cache.addCollection(index, collection);

    if (creationOptions.propagate) {
