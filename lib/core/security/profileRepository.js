...
class ProfileRepository extends Repository {
  ...
  init (options = {}) {
    ...
    this.kuzzle.onAsk(
      ...
      (id, policies, opts) => this.update(id, policies, opts));
  }
   ...
   * @returns {Role}
   */
  async create (id, policies, opts) {
    return this._createOrReplace(id, policies, {
      method: 'create',
      ...opts,
    });
  }
   ...
   * @returns {Role}
   */
  async createOrReplace (id, policies, opts) {
    return this._createOrReplace(id, policies, {
   ...
   * @return {Promise}
   */
  async update (id, policies, {refresh, retryOnConflict, userId} = {}) {
   ...
   * @override
   */
  async delete (profile, {refresh = null} = {}) {
