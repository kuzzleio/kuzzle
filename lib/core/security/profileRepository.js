...
class ProfileRepository extends Repository {
  ...
  init (options = {}) {
    ...
    // Events registration
    this.kuzzle.onAsk('core:security:profiles:truncate', this.onTruncate.bind(this));
    this.kuzzle.onPipe('admin:afterResetSecurity', this.clearCache.bind(this));

    // Need to reset cache even if resetting security documents fails, as it
    // might file at any step during the process
