...
const Token = require('./document/token');
...
class TokenRepository extends Repository {
  ...
  async init() {
    ...
    onAsk('core:security:tokens:delete', id => this.deleteByUserId(id));
    onAsk('core:security:tokens:expire', token => this.expire(token));
    onAsk(
    ...
    onAsk('core:security:tokens:verify', token => this.verifyToken(token));
  }
