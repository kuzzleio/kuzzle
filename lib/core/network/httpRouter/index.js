...
class Router {
  constructor() {
    ...
    this.defaultHeaders = {
      ...
      'Access-Control-Allow-Headers': this.kuzzle.config.http.accessControlAllowHeaders,
      'Access-Control-Allow-Methods': this.kuzzle.config.http.accessControlAllowMethods,
      'Access-Control-Allow-Origin': this.kuzzle.config.http.accessControlAllowOrigin,
