...
const
  errorsManager = require('../../../util/errors').wrap('network', 'mqtt'),
  Bluebird = require('bluebird'),
  debug = require('../../../util/debug')('kuzzle:entry-point:protocols:mqtt'),
...
class MqttProtocol extends Protocol {
  ...
  broadcast (data) {
    ...
    for (const channel of data.channels) {
      this.server.publish({payload, topic: channel});
    }
  }
