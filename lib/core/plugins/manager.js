...
class PluginsManager {
  ...
  isController (controller) { 
    const routes = this.routes.filter(route => route.controller === controller);
  ...
  /**
   * Tell if the controller is a plugin controller or not
   * 
   * @param {String} controller
   * @returns {Boolean}
   */
  isPluginController (controller) {
