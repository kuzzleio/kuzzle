...
class PluginContext {
  ...
  constructor(kuzzle, pluginName) {
    ...
    if (kuzzle instanceof Kuzzle) {
      ...
      Reflect.defineProperty(this, 'log', {
        ...
        get: () => {
          return {
            ...
            verbose: msg => kuzzle.log.verbose(`[plugin-${pluginName}] ${msg}`),
      ...
      Reflect.defineProperty(this.accessors, 'beforeDocumentWrite', {
        enumerable: true,
        get: () => (...args) => kuzzle.pluginsManager.beforeDocumentWrite(pluginName, ...args)
      });
    }
  }
}
