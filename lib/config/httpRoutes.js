...
const routes = [
  ...
  { verb: 'get', path: '/users/:_id', controller: 'user', action: 'get', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_strategies', controller: 'user', action: 'strategies', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_strategies' } }, // @deprecated
  { verb: 'get', path: '/users/_mGet', controller: 'user', action: 'mGet', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_rights', controller: 'user', action: 'rights', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_rights' } }, // @deprecated
  ...
  { verb: 'get', path: '/users/_mapping', controller: 'user', action: 'mappings', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } },
  { verb: 'get', path: '/users/_scroll/:scrollId', controller: 'user', action: 'scroll', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_scroll/:scrollId' } },
  ...
  { verb: 'post', path: '/_security/users/_refresh', controller: 'security', action: 'refresh', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/users/_refresh' } }, // @deprecated
  { verb: 'post', path: '/_security/:collection/_refresh', controller: 'security', action: 'refresh' },
  { verb: 'post', path: '/users/_refresh', controller: 'user', action: 'refresh' },
  ...
  { verb: 'post', path: '/users/_createRestricted', controller: 'user', action: 'createRestricted', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_createRestricted' } },
  { verb: 'post', path: '/users/:_id/_createRestricted', controller: 'user', action: 'createRestricted', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_createRestricted' } },
  { verb: 'post', path: '/users/_create', controller: 'user', action: 'create', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_create' } },
  { verb: 'post', path: '/users/:_id/_create', controller: 'user', action: 'create', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_create' } },
  ...
  { verb: 'post', path: '/users/_mDelete', controller: 'user', action: 'mDelete', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mDelete' } },
  { verb: 'post', path: '/profiles/_mGet', controller: 'security', action: 'mGetProfiles' },
  { verb: 'post', path: '/users/_mGet', controller: 'user', action: 'mGet', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } },
  ...
  { verb: 'post', path: '/users/_search', controller: 'user', action: 'search'},
  { verb: 'post', path: '/users/_search', controller: 'security', action: 'searchUsers', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_search' } },
  ...
  { verb: 'post', path: '/_checkRights/:userId', controller: 'user', action: 'checkRights' },
  ...
  { verb: 'delete', path: '/users/:_id', controller: 'user', action: 'delete', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:id' } },
  { verb: 'delete', path: '/credentials/:strategy/:_id', controller: 'security', action: 'deleteCredentials' },
  { verb: 'delete', path: '/users/:_id/tokens', controller: 'user', action: 'revokeTokens', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/tokens' } },
  ...
  { verb: 'put', path: '/users/:_id/_update', controller: 'user', action: 'update', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_update' } },
  { verb: 'put', path: '/users/:_id/_replace', controller: 'user', action: 'replace', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_replace' } },
  ...
  { verb: 'put', path: '/users/_mapping', controller: 'user', action: 'updateMappings', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } },
