...
const routes = [
  ...
  { verb: 'put', path: '/:index/:collection/_createOrReplace', controller: 'document', action: 'create', info: {parameters: DocumentCreateOrReplace.put.parameters, responses: DocumentCreateOrReplace.put.responses} },
