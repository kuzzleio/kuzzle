...
const routes = [
  ...
  { verb: 'get', path: '/:index/:collection/:_id/_exists', controller: 'document', action: 'exists', info: {parameters: DocumentExists.get.parameters, responses: DocumentExists.get.responses} },
