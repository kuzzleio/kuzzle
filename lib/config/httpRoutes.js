...
module.exports = [
  ...
  {verb: 'get', url: '/admin/resetCache/:database', controller: 'admin', action: 'resetCache'},
  {verb: 'get', url: '/admin/resetSecurity/', controller: 'admin', action: 'resetSecurity'},
  {verb: 'get', url: '/admin/resetDatabase/', controller: 'admin', action: 'resetDatabase'},
  {verb: 'get', url: '/admin/resetPluginStorage/:plugin', controller: 'admin', action: 'resetPluginStorage'},
  {verb: 'get', url: '/admin/resetKuzzleData/', controller: 'admin', action: 'resetKuzzleData'},
  {verb: 'get', url: '/admin/shutdown/', controller: 'admin', action: 'shutdown'},
