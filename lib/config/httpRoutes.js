...
const routes = [
  ...
  { verb: 'get', path: '/:index/:collection/:documentId/_get', controller: 'document', action: 'get', info: {parameters: DocumentGet.get.parameters, responses: DocumentGet.get.responses} },
