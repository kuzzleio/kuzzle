...
const routes = [
  ...
  { verb: 'get', path: '/users/:_id', controller: 'security', action: 'getUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_strategies', controller: 'security', action: 'getUserStrategies', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_strategies' } }, // @deprecated
  { verb: 'get', path: '/users/_mGet', controller: 'security', action: 'mGetUsers', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_rights', controller: 'security', action: 'getUserRights', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_rights' } }, // @deprecated
  ...
  { verb: 'get', path: '/users/_mapping', controller: 'security', action: 'getUserMapping', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } }, // @deprecated
  { verb: 'get', path: '/users/_scroll/:scrollId', controller: 'security', action: 'scrollUsers', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_scroll/:scrollId' } }, // @deprecated
  ...
  { verb: 'get', path: '/user/_mappings', controller: 'user', action: 'getMappings' },
  { verb: 'get', path: '/user/:_id/_rights', controller: 'user', action: 'getRights' },
  { verb: 'get', path: '/user/:_id/_strategies', controller: 'user', action: 'getStrategies' },
  ...
  // POST
  { verb: 'post', path: '/_sign-in', controller: 'auth', action: 'signin' },
  { verb: 'post', path: '/:_id/_sign-in', controller: 'auth', action: 'signin' },
  ...
  { verb: 'post', path: '/_createFirstAdmin/:_id', controller: 'security', action: 'createFirstAdmin', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_create' } }, // @deprecated
  { verb: 'post', path: '/_createFirstAdmin', controller: 'security', action: 'createFirstAdmin', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_create' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_createRestricted', controller: 'security', action: 'createRestrictedUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/_signin' } }, // @deprecated
  { verb: 'post', path: '/users/:_id/_createRestricted', controller: 'security', action: 'createRestrictedUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/:_id/_signin' } }, // @deprecated
  { verb: 'post', path: '/users/_create', controller: 'security', action: 'createUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_create' } }, // @deprecated
  { verb: 'post', path: '/users/:_id/_create', controller: 'security', action: 'createUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_create' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_mDelete', controller: 'security', action: 'mDeleteUsers', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_mDelete' } }, // @deprecated
  { verb: 'post', path: '/profiles/_mGet', controller: 'security', action: 'mGetProfiles' },
  { verb: 'post', path: '/users/_mGet', controller: 'security', action: 'mGetUsers', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_search', controller: 'security', action: 'searchUsers', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_search' } }, // @deprecated
  ...
  { verb: 'post', path: '/_checkRights/:userId', controller: 'security', action: 'checkRights', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_isAllowed' } }, // @deprecated
  ...
  { verb: 'post', path: '/user/:_id/_isAllowed', controller: 'user', action: 'isAllowed' },
  ...
  { verb: 'delete', path: '/users/:_id', controller: 'security', action: 'deleteUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id' } }, // @deprecated
  { verb: 'delete', path: '/credentials/:strategy/:_id', controller: 'security', action: 'deleteCredentials' },
  { verb: 'delete', path: '/users/:_id/tokens', controller: 'security', action: 'revokeTokens', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/tokens' } }, // @deprecated
  ...
  { verb: 'put', path: '/users/:_id/_update', controller: 'security', action: 'updateUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_update' } }, // @deprecated
  { verb: 'put', path: '/users/:_id/_replace', controller: 'security', action: 'replaceUser', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_replace' } }, // @deprecated
  ...
  { verb: 'put', path: '/users/_mapping', controller: 'security', action: 'updateUserMapping', deprecated: { since: 'auto-version', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } }, // @deprecated
