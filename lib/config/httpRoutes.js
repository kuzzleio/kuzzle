module.exports = [
  ...
  {verb: 'post', url: '/:index/:collection/_validate', controller: 'write', action: 'validateDocument'},
  ...
  {verb: 'put', url: '/_validateSpecifications', controller: 'admin', action: 'validateSpecifications'},
