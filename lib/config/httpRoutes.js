...
const routes = [
  ...
  { verb: 'get', path: '/users/:_id', controller: 'security', action: 'getUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_strategies', controller: 'security', action: 'getUserStrategies', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_strategies' } }, // @deprecated
  { verb: 'get', path: '/users/_mGet', controller: 'security', action: 'mGetUsers', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } }, // @deprecated
  { verb: 'get', path: '/users/:_id/_rights', controller: 'security', action: 'getUserRights', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_rights' } }, // @deprecated
  ...
  { verb: 'get', path: '/users/_mapping', controller: 'security', action: 'getUserMapping', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } }, // @deprecated
  { verb: 'get', path: '/users/_scroll/:scrollId', controller: 'security', action: 'scrollUsers', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_scroll/:scrollId' } }, // @deprecated
  ...
  { verb: 'get', path: '/user/:_id', controller: 'user', action: 'get' },
  { verb: 'get', path: '/user/_mGet', controller: 'user', action: 'mGet' },
  { verb: 'get', path: '/user/_scroll/:scrollId', controller: 'user', action: 'scroll' },
  { verb: 'get', path: '/user/_mappings', controller: 'user', action: 'mappings' },
  { verb: 'get', path: '/user/:_id/_rights', controller: 'user', action: 'rights' },
  { verb: 'get', path: '/user/:_id/_strategies', controller: 'user', action: 'strategies' },
  ...
  { verb: 'post', path: '/_createFirstAdmin/:_id', controller: 'security', action: 'createFirstAdmin', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_createFirstAdmin' } }, // @deprecated
  { verb: 'post', path: '/_createFirstAdmin', controller: 'security', action: 'createFirstAdmin', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_createFirstAdmin' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_createRestricted', controller: 'security', action: 'createRestrictedUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_createRestricted' } }, // @deprecated
  { verb: 'post', path: '/users/:_id/_createRestricted', controller: 'security', action: 'createRestrictedUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_createRestricted' } }, // @deprecated
  { verb: 'post', path: '/users/_create', controller: 'security', action: 'createUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_create' } }, // @deprecated
  { verb: 'post', path: '/users/:_id/_create', controller: 'security', action: 'createUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_create' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_mDelete', controller: 'security', action: 'mDeleteUsers', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_mDelete' } }, // @deprecated
  { verb: 'post', path: '/profiles/_mGet', controller: 'security', action: 'mGetProfiles' },
  { verb: 'post', path: '/users/_mGet', controller: 'security', action: 'mGetUsers', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_mGet' } }, // @deprecated
  ...
  { verb: 'post', path: '/users/_search', controller: 'security', action: 'searchUsers', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_search' } }, // @deprecated
  ...
  { verb: 'post', path: '/_checkRights/:userId', controller: 'security', action: 'checkRights', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_checkRights' } }, // @deprecated
  ...
  { verb: 'post', path: '/user/_createFirstAdmin', controller: 'user', action: 'createFirstAdmin' },
  { verb: 'post', path: '/user/:_id/_createFirstAdmin', controller: 'user', action: 'createFirstAdmin' },
  { verb: 'post', path: '/user/_createRestricted', controller: 'user', action: 'createRestricted' },
  { verb: 'post', path: '/user/:_id/_createRestricted', controller: 'user', action: 'createRestricted' },
  { verb: 'post', path: '/user/_create', controller: 'user', action: 'create' },
  { verb: 'post', path: '/user/:_id/_create', controller: 'user', action: 'create' },
  { verb: 'post', path: '/user/_mDelete', controller: 'user', action: 'mDelete'},
  { verb: 'post', path: '/user/_mGet', controller: 'user', action: 'mGet' },
  { verb: 'post', path: '/user/_search', controller: 'user', action: 'search' },
  { verb: 'post', path: '/user/_refresh', controller: 'user', action: 'refresh' },
  { verb: 'post', path: '/user/:_id/_checkRights', controller: 'user', action: 'checkRights' },
  ...
  { verb: 'delete', path: '/users/:_id', controller: 'security', action: 'deleteUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id' } }, // @deprecated
  { verb: 'delete', path: '/credentials/:strategy/:_id', controller: 'security', action: 'deleteCredentials' },
  { verb: 'delete', path: '/users/:_id/tokens', controller: 'security', action: 'revokeTokens', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/tokens' } }, // @deprecated

  { verb: 'delete', path: '/user/:_id', controller: 'user', action: 'delete' },
  { verb: 'delete', path: '/user/:_id/tokens', controller: 'user', action: 'revokeTokens' },
  ...
  { verb: 'put', path: '/users/:_id/_update', controller: 'security', action: 'updateUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_update' } }, // @deprecated
  { verb: 'put', path: '/users/:_id/_replace', controller: 'security', action: 'replaceUser', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/:_id/_replace' } }, // @deprecated
  ...
  { verb: 'put', path: '/users/_mapping', controller: 'security', action: 'updateUserMapping', deprecated: { since: '2.13.0', message: 'Use this route instead: http://kuzzle:7512/user/_mappings' } }, // @deprecated
  { verb: 'put', path: '/user/:_id/_update', controller: 'user', action: 'update' },
  { verb: 'put', path: '/user/:_id/_replace', controller: 'user', action: 'replace' },
  { verb: 'put', path: '/user/_mappings', controller: 'user', action: 'updateMappings' },
