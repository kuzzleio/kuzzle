...
const routes = [
  ...
  { verb: 'post', path: '/:index/:collection/_count', controller: 'document', action: 'count', openapi: {parameters: DocumentCount.post.parameters, responses: DocumentCount.post.responses} },
