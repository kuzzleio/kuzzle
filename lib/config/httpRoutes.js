...
const routes = [
  ...
  { verb: 'get', path: '/users/_me', controller: 'auth', action: 'getCurrentUser', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me' } }, // @deprecated
  { verb: 'get', path: '/users/_me/_rights', controller: 'auth', action: 'getMyRights', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/_rights' } }, // @deprecated
  { verb: 'get', path: '/credentials/:strategy/_me', controller: 'auth', action: 'getMyCredentials', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy' } }, // @deprecated
  { verb: 'get', path: '/credentials/:strategy/_me/_exists', controller: 'auth', action: 'credentialsExist', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy/_exists' } }, // @deprecated
  ...
  { verb: 'get', path: '/_publicApi', controller: 'server', action: 'publicApi', deprecated: { since: '2.5.0', message: 'http://kuzzle:7512/_openapi' } }, // @deprecated
  ...
  { verb: 'post', path: '/credentials/:strategy/_me/_create', controller: 'auth', action: 'createMyCredentials', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy/_create' } }, // @deprecated
  { verb: 'post', path: '/credentials/:strategy/_me/_validate', controller: 'auth', action: 'validateMyCredentials', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy/_validate' } }, // @deprecated
  ...
  { verb: 'delete', path: '/credentials/:strategy/_me', controller: 'auth', action: 'deleteMyCredentials', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy' } }, // @deprecated
  ...
  { verb: 'put', path: '/_updateSelf', controller: 'auth', action: 'updateSelf', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me' } }, // @deprecated
  { verb: 'put', path: '/credentials/:strategy/_me/_update', controller: 'auth', action: 'updateMyCredentials', deprecated: { since: '2.4.0', message: 'http://kuzzle:7512/_me/credentials/:strategy/_update' } }, // @deprecated
