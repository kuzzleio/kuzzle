...
const routes = [
  ...
  { verb: 'get', path: '/users/:_id', controller: 'user', action: 'get' },
  { verb: 'get', path: '/users/:_id/_strategies', controller: 'user', action: 'strategies' },
  { verb: 'get', path: '/users/_mGet', controller: 'user', action: 'mGet' },
  { verb: 'get', path: '/users/:_id/_rights', controller: 'user', action: 'rights' },
  ...
  { verb: 'post', path: '/users/_createRestricted', controller: 'user', action: 'createRestricted' },
  { verb: 'post', path: '/users/:_id/_createRestricted', controller: 'user', action: 'createRestricted' },
  { verb: 'post', path: '/users/_create', controller: 'user', action: 'create' },
  { verb: 'post', path: '/users/:_id/_create', controller: 'user', action: 'create' },
  ...
  { verb: 'post', path: '/users/_mGet', controller: 'user', action: 'mGet' },
  ...
  { verb: 'delete', path: '/users/:_id', controller: 'user', action: 'delete' },
  ...
  { verb: 'put', path: '/users/:_id/_update', controller: 'user', action: 'update' },
  { verb: 'put', path: '/users/:_id/_replace', controller: 'user', action: 'replace' },
  ...
  { verb: 'put', path: '/users/_mapping', controller: 'user', action: 'mapping' }
];
