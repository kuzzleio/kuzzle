...
const routes = [
  ...
  { verb: 'delete', path: '/:index/:collection/:_id', controller: 'document', action: 'delete', info: {parameters: DocumentDelete.delete.parameters, responses: DocumentDelete.delete.responses} },
