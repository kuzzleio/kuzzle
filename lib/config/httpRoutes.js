...
const {
  DocumentCount,
  DocumentUpdate,
} = require('../api/swagger/documents/document');
...
const routes = [
  ...
  { verb: 'post', path: '/:index/:collection/_count', controller: 'document', action: 'count', info: {parameters: DocumentCount.post.parameters, responses: DocumentCount.post.responses} },
  ...
  { verb: 'put', path: '/:index/:collection/:_id/_update', controller: 'document', action: 'update', deprecated: { since: '2.11.0', message: 'Use "document:update" route with PATCH instead of PUT' }, info: {parameters: DocumentUpdate.put.parameters, responses: DocumentUpdate.put.responses} }, // @deprecated
