...
const routes = [
  ...
  { verb: 'get', path: '/users/_mapping', controller: 'user', action: 'mappings' },
  { verb: 'get', path: '/users/_scroll/:scrollId', controller: 'user', action: 'scroll' },
  ...
  { verb: 'put', path: '/users/_mapping', controller: 'user', action: 'mapping', deprecated: { since: '2.10.3', message: 'Use this route instead: http://kuzzle:7512/user/_mapping' } },
  ...
  { verb: 'put', path: '/user/_mappings', controller: 'user', action: 'mappings' }
];
