module.exports = [
  ...
  {verb: 'post', url: '/profiles/_mdelete', controller: 'security', action: 'mDeleteProfile'},
  {verb: 'post', url: '/roles/_mdelete', controller: 'security', action: 'mDeleteRole'},
  {verb: 'post', url: '/users/_mdelete', controller: 'security', action: 'mDeleteUser'},
  {verb: 'post', url: '/profiles/_mget', controller: 'security', action: 'mGetProfile'},
  {verb: 'post', url: '/roles/_mget', controller: 'security', action: 'mGetRole'},
