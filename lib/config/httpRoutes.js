...
const routes = [
  ...
  { verb: 'delete', path: '/:index/:collection/:documentId/[?refresh=wait_for]/[&source]/[&silent]/_delete', controller: 'document', action: 'delete', info: {parameters: DocumentDelete.delete.parameters, responses: DocumentDelete.delete.responses} },
