...
const routes = [
  ...
  { verb: 'delete', path: '/:index/:collection/:documentId', controller: 'document', action: 'delete', info: {parameters: DocumentDelete.delete.parameters, responses: DocumentDelete.delete.responses} },
