...
const routes = [
  ...
  { verb: 'post', path: '/:index/:collection/_create', controller: 'document', action: 'create', info: {parameters: DocumentCreate.post.parameters, responses: DocumentCreate.post.responses} },
