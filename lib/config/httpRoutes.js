module.exports = [
  ...
  {verb: 'get', url: '/_serverInfo', controller: 'read', action: 'serverInfo'},
  ...
  {verb: 'get', url: '/users/_mapping', controller: 'admin', action: 'getUserMapping'},
  ...
  {verb: 'put', url: '/users/_mapping', controller: 'admin', action: 'updateUserMapping'},
