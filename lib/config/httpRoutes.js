...
const routes = [
  ...
  {verb: 'get', path: '/users/_me', controller: 'auth', action: 'getCurrentUser'}, // @deprecated
  {verb: 'get', path: '/users/_me/_rights', controller: 'auth', action: 'getMyRights'}, // @deprecated
  {verb: 'get', path: '/credentials/:strategy/_me', controller: 'auth', action: 'getMyCredentials'}, // @deprecated
  {verb: 'get', path: '/credentials/:strategy/_me/_exists', controller: 'auth', action: 'credentialsExist'}, // @deprecated
  ...
  {verb: 'get', path: '/_publicApi', controller: 'server', action: 'publicApi'}, // @deprecated
  {verb: 'get', path: '/_swagger', controller: 'server', action: 'swagger'},
  ...
  {verb: 'post', path: '/credentials/:strategy/_me/_create', controller: 'auth', action: 'createMyCredentials'}, // @deprecated
  {verb: 'post', path: '/credentials/:strategy/_me/_validate', controller: 'auth', action: 'validateMyCredentials'}, // @deprecated
  ...
  {verb: 'delete', path: '/credentials/:strategy/_me', controller: 'auth', action: 'deleteMyCredentials'}, // @deprecated
  ...
  {verb: 'put', path: '/_updateSelf', controller: 'auth', action: 'updateSelf'}, // @deprecated
  {verb: 'put', path: '/credentials/:strategy/_me/_update', controller: 'auth', action: 'updateMyCredentials'}, // @deprecated
  ...
  {verb: 'put', path: '/:index/:collection/_mapping', controller: 'collection', action: 'updateMapping'},
