...
const routes = [
  ...
  { verb: 'get', path: '/users/_mapping', controller: 'user', action: 'mapping' },
  ...
  { verb: 'get', path: '/user/_mapping', controller: 'user', action: 'mapping' },
  ...
  { verb: 'put', path: '/user/_mapping', controller: 'user', action: 'mapping' }
];
