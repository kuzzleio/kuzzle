...
const routes = [
  ...
  { verb: 'put', path: '/:index/:collection/:_id/_replace', controller: 'document', action: 'replace', info: {parameters: DocumentReplace.put.parameters, responses: DocumentReplace.put.responses} },
