...
const routes = [
  ...
  { verb: 'delete', path: '/:index/:collection/_query/[?refresh=wait_for]/[&source]/[&lang=<query language>]/[&silent]/_deleteByQuery', controller: 'document', action: 'deleteByQuery', info: {parameters: DocumentDeleteByQuery.delete.parameters, responses: DocumentDeleteByQuery.delete.responses} },
