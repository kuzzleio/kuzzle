...
function checkServerConfig (cfg) {
  ...
  => Restoring the following default settings: maxConcurrentRequests = ${defaultConfig.server.maxConcurrentRequests}, maxRetainedRequests = ${defaultConfig.server.maxRetainedRequests}`);
