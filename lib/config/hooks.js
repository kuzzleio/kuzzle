module.exports = {
  ...
  'prepareDb:createInternalIndex': ['write:emit'],
  'prepareDb:createFixturesIndex': ['write:emit'],
  'prepareDb:updateMappingRoles': ['write:emit'],
  'prepareDb:updateMappingProfiles': ['write:emit'],
  'prepareDb:updateMappingUsers': ['write:emit'],
  'prepareDb:importMapping': ['write:emit'],
  'prepareDb:importFixtures': ['write:emit']
};
