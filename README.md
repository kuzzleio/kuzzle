[![Build Status](https://travis-ci.org/kuzzleio/kuzzle.svg?branch=master)](https://travis-ci.org/kuzzleio/kuzzle) [![Coverage Status](https://coveralls.io/repos/kuzzleio/kuzzle/badge.svg?branch=master&service=github)](https://coveralls.io/github/kuzzleio/kuzzle?branch=master)  [![Dependency Status](https://david-dm.org/kuzzleio/kuzzle.svg)](https://david-dm.org/kuzzleio/kuzzle)
