...
Otherwise, the provided error is embedded into a [InternalError](/core/1/protocols/api/context/errors/#internalerror) object, and the request status is set to 500.
