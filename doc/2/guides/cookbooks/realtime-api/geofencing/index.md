...
[geoBoundingBox](/core/2/guides/cookbooks/realtime-api/terms#geoboundingbox), [geoDistance](/core/2/guides/cookbooks/realtime-api/terms#geodistance), [geoDistanceRange](/core/2/guides/cookbooks/realtime-api/terms#geodistancerange) and [geoPolygon](/core/2/guides/cookbooks/realtime-api/terms#geopolygon). In this section, you will find a detailed
...
Distances used in geofencing filters such as [geoDistance](/core/2/guides/cookbooks/realtime-api/terms#geodistance) or [geoDistanceRange](/core/2/guides/cookbooks/realtime-api/terms#geodistance-range) can be expressed in various ways.
