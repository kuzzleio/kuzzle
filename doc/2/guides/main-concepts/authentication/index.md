...
This is possible thanks to the [HTTP-only](/core/2/api/protocols/http/index.md#http-only-options) option [cookieAuth](../../../api/protocols/http/index.md#cookieAuth)
