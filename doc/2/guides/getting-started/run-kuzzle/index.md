...
For the sake of simplicity we will use a Docker and Docker Compose throughout this guide. Make sure to have them correctly installed before going further, especially the [Docker as a non root user section](https://docs.docker.com/engine/install/linux-postinstall/#manage-docker-as-a-non-root-user) which is a recurrent trouble.
::: 
