...
For production deployments, we strongly recommend to deploy your application in [cluster mode](/core/2/guides/advanced/5-cluster-scalability) to take advantage of high availability and scalability.  
