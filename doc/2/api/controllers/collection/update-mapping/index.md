...
* `dynamic`: [dynamic mapping policy](/core/2/guides/main-concepts/2-data-storage#mappings-dynamic-policy) for new fields. Allowed values: `true` (default), `false`, `strict`
