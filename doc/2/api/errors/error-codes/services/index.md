...
| services.storage.invalid_multi_index_collection_usage<br/><pre>0x01010031</pre>  | [BadRequestError](/core/2/api/errors/error-codes#badrequesterror) <pre>(400)</pre> | The arguments "index" and "collection" have been used instead of "targets" to specify multiple index and collections | The arguments "index" and "collection" have been used instead of "targets" to specify multiple index and collections |
