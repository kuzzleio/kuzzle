...
| services.storage.version_mismatch<br/><pre>0x0101000d</pre>  | [InternalError](/core/2/api/errors/error-codes#internalerror) <pre>(500)</pre> | Your elasticsearch version is %s; Only elasticsearch version 5 is currently supported. | The version of the target Elasticsearch is not compatible with this version of Kuzzle |
