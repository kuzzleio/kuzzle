...
| security.token.refresh_forbidden<br/><pre>0x07010008</pre>  | [UnauthorizedError](/core/2/api/errors/error-codes#unauthorizederror) <pre>(401)</pre> | Token cannot be refreshed. | The provided token cannot be refreshed: %s cannot be refreshed. |
