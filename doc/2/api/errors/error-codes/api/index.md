...
| api.process.deprecated_embedded_sdk_action<br/><pre>0x0202000e</pre>  | [DeprecatedEmbeddedSdkAction](/core/2/api/errors/error-codes#deprecatedembeddedsdkaction) <pre>(400)</pre> | A deprecated sdk action has been called | The action %s of the controller %s has been called while it is deprecated %s. |
