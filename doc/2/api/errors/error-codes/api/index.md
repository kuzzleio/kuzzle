...
| api.process.forbidden_embedded_sdk_action<br/><pre>0x0202000e</pre>  | [BadRequestError](/core/2/api/errors/error-codes#pluginimplementationerror) <pre>(400)</pre> | The action %s of the controller %s has been called while it is forbidden in the embedded sdk%s. | A forbidden embdedded sdk action has been called |
