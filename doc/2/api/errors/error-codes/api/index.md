...
| api.assert.unsupported_protocol<br/><pre>0x02010010</pre>  | [InternalError](/core/2/api/errors/error-codes#internalerror) <pre>(500)</pre> | The protocol "%s" is not supported. | A request has been made with an unsupported protocol |
