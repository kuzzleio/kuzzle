...
| plugin.assert.plugin_not_found<br/><pre>0x0401000f</pre>  | [NotFoundError](/core/2/api/errors/error-codes#notfounderror) <pre>(404)</pre> | Plugin "%s" not found.%s | The requested plugin does not exist or have not been loaded yet. |
