...
4139  | `[<placeholder>/manifest.json] No "kuzzleVersion" property found.` | [PluginImplementationError](https://docs.kuzzle.io/core/1/api/essentials/errors/#pluginimplementationerror) | missing_kuzzleVersion | plugins.validation.missing_kuzzleVersion
