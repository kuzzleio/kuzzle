...
| services.storage.index_already_exists<br/><pre>0x01010026</pre> | [PreconditionError](/core/1/api/essentials/errors/handling#preconditionerror) <pre>(412)</pre> | Attempted to create an already existing index |
| services.storage.forbidden_character<br/><pre>0x01010027</pre> | [BadRequestError](/core/1/api/essentials/errors/handling#badrequesterror) <pre>(400)</pre> | An index name contains a forbidden character |
...
| network.entrypoint.shutting_down<br/><pre>0x03040003</pre> | [ServiceUnavailableError](/core/1/api/essentials/errors/handling#serviceunavailableerror) <pre>(503)</pre> | Request rejected because this instance is shutting down |
...
| plugin.manifest.missing_version<br/><pre>0x0405000a</pre> | [PluginImplementationError](/core/1/api/essentials/errors/handling#pluginimplementationerror) <pre>(500)</pre> | Plugin manifest files must provide a kuzzleVersion parameter, with the range of compatible Kuzzle versions |
