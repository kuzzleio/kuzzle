...
You can see the full definition about Kuzzle errors [here](/core/2/api/essentials/errors/subcodes/)
...
You can see the full definition of Kuzzle API errors [here](/core/2/api/essentials/errors/subcodes/)
