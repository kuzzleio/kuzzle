...
| plugin.context.unavailable_realtime<br/><pre>0x04060002</pre> | [PluginImplementationError](/core/2/api/essentials/error-handling#pluginimplementationerror) <pre>(500)</pre> | Due to technical limitations, subscribe and unsubscribe methods are only available in the embedded SDK. |
