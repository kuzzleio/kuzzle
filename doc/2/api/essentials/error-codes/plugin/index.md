...
| plugin.context.invalid_user<br/><pre>0x04060003</pre> | [PluginImplementationError](/core/2/api/essentials/error-handling#pluginimplementationerror) <pre>(500)</pre> | The user object provided to the sdk.as() method is not of type User |
