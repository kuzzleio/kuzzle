...
| security.user.no_profile<br/><pre>0x07040007</pre> | [InternalError](/core/2/api/essentials/error-handling#internalerror) <pre>(500)</pre> | Database inconsistency error: a user do not have profiles associated to it |
