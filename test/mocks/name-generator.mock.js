...
class NameGeneratorMock {
  ...
  static generateRandomNameMock ({ prefix, separator = '-', postfixRandRange = { min: 0, max: 100000 } }) {
    ...
    return `${prefix}${adjective}${separator}${name}${separator}${randomNumberMock(min, max)}`;
  }
}
