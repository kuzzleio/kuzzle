...
function KuzzleMock () {
  ...
  this.pluginsManager = {
    ...
    trigger: sinon.spy(function (...args) {return Bluebird.resolve(args[1]);}),
  ...
  this.repositories = {
    ...
    role: {
      getRoleFromRequest: sinon.spy(function (...args) {return Bluebird.resolve(args[0]);}),
      loadRole: sinon.stub().returns(Bluebird.resolve()),
      loadRoles: sinon.stub().returns(Bluebird.resolve()),
      validateAndSaveRole: sinon.spy(function (...args) {return Bluebird.resolve(args[0]);})
    },
    user: {
  ...
  this.validation = {
    ...
    validate: sinon.spy(function (...args) {return Bluebird.resolve(args[0]);}),
    validationPromise: sinon.spy(function (...args) {return Bluebird.resolve(args[0]);}),
    addType: sinon.spy()
  };
