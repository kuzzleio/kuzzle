...
describe("Test: security controller - credentials", () => {
  ...
  describe("#createCredentials", () => {
    it("should call the plugin create method", () => {
      ...
      return securityController.createCredentials(request).then((result) => {
  ...
  describe("#updateCredentials", () => {
    it("should call the plugin update method", () => {
      ...
      return securityController.updateCredentials(request).then((result) => {
        should(result).be.deepEqual({ foo: "bar" });
        should(kuzzle.pluginsManager.getStrategyMethod).be.calledTwice();
        should(
          kuzzle.pluginsManager.getStrategyMethod.firstCall.args[0],
  ...
  describe("#hasCredentials", () => {
    it("should call the plugin exists method", () => {
      ...
      return securityController.hasCredentials(request).then((result) => {
        should(result).be.deepEqual({ foo: "bar" });
  ...
  describe("#validateCredentials", () => {
    it("should call the plugin validate method", () => {
      ...
      return securityController.validateCredentials(request).then((result) => {
        should(result).be.deepEqual({ foo: "bar" });
        should(kuzzle.pluginsManager.getStrategyMethod).be.calledOnce();
        should(
          kuzzle.pluginsManager.getStrategyMethod.firstCall.args[0],
  ...
  describe("#deleteCredentials", () => {
    it("should call the plugin delete method", () => {
      ...
      return securityController.deleteCredentials(request).then((result) => {
  ...
  describe("#searchUsersByCredentials", () => {
    ...
    it('should call the "translateKoncorde" method if "lang" is "koncorde"', async () => {
      ...
      should(securityController.translateKoncorde).be.calledWith({
  ...
  describe("#getCredentials", () => {
    it("should call the plugin getInfo method if it is provided", () => {
      ...
      return securityController.getCredentials(request).then((result) => {
        should(result).be.deepEqual({ foo: "bar" });
  ...
  describe("#getCredentialsById", () => {
    it("should call the plugin getById method if it is provided", () => {
      ...
      return securityController.getCredentialsById(request).then((result) => {
        should(result).be.deepEqual({ foo: "bar" });
        should(kuzzle.pluginsManager.hasStrategyMethod).be.calledOnce();
        should(
          kuzzle.pluginsManager.hasStrategyMethod.firstCall.args[0],
  ...
  describe("#getCredentialFields", () => {
    it("should return the list of a strategy's fields", () => {
      ...
      kuzzle.pluginsManager.getStrategyFields.returns([
        "aField",
        "anotherField",
      ]);

      return securityController.getCredentialFields(request).then((result) => {
  ...
  describe("#getAllCredentialFields", () => {
    it("should return the list of all strategies' fields", () => {
      ...
      kuzzle.pluginsManager.listStrategies.returns([
        "someStrategy",
        "someOtherStrategy",
      ]);
      kuzzle.pluginsManager.getStrategyFields.returns([
      ...
      return securityController
        .getAllCredentialFields(request)
        .then((result) => {
          should(result).be.deepEqual({
