...
describe("Test: security controller - profiles", () => {
  ...
  describe("#createOrReplaceProfile", () => {
    ...
    it("should throw if an invalid profile format is provided", async () => {
      ...
      should(securityController.createOrReplaceProfile(request)).rejectedWith(
        BadRequestError,
        {
  ...
  describe("#createProfile", () => {
    ...
    beforeEach(() => {
      createStub = kuzzle.ask.withArgs(createEvent).resolves(fakeProfile);
  ...
  describe("#searchProfiles", () => {
    ...
    it("should reject if the number of documents per page exceeds the server limits", async () => {
      ...
      await should(securityController.searchProfiles(request)).rejectedWith(
        SizeLimitError,
        {
  ...
  describe("#scrollProfiles", () => {
    ...
    it("should reject if no scrollId is provided", async () => {
      await should(securityController.scrollProfiles(request)).rejectedWith(
        BadRequestError,
        {
          id: "api.assert.missing_argument",
  ...
  describe("#deleteProfile", () => {
    ...
    it("should reject if no _id is provided", async () => {
      ...
      await should(securityController.deleteProfile(request)).rejectedWith(
        BadRequestError,
        {
          id: "api.assert.missing_argument",
          message: 'Missing argument "_id".',
  ...
  describe("#getProfileRights", () => {
    ...
    it("should reject an error on if invoked without an id", async () => {
      ...
      await should(securityController.getProfileRights(request)).rejectedWith(
        BadRequestError,
        {
          id: "api.assert.missing_argument",
          message: 'Missing argument "_id".',
