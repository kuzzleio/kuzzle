...
describe("#Request", () => {
  ...
  it("should add a deprecation when kuzzle is in development", () => {
    ...
    should(rq.deprecations[0]).deepEqual({
      version: "1.0.0",
      message: "You should now use Kuzzle v2",
    });
  });
  ...
  describe("param extraction methods", () => {
    ...
    describe("#getLangParam", () => {
      ...
      it('should throw an error if "lang" is invalid', () => {
        ...
        should(() => request.getLangParam()).throwError({
    ...
    describe("#getBoolean", () => {
      ...
      it("throw an error if flag is not a boolean with other protocols", () => {
        ...
        should(() => request.getBoolean("doha")).throw(BadRequestError, {
    ...
    describe("#request body getters", () => {
      ...
      describe("#getBodyArray", () => {
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getBodyArray("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an array", () => {
          should(() => request.getBodyArray("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
        ...
        it("should throw if the request does not have a body", () => {
          ...
          should(() => request.getBodyArray("names")).throw(BadRequestError, {
        ...
        it("should return the default value if one is provided, and if the request has no body", () => {
          ...
          should(request.getBodyArray("names", def)).exactly(def);
        });

        it("should throw if the value is a string and not try to parse it since it is not a query string", () => {
          request.context.connection.protocol = "ws";
          should(() => request.getBodyArray("ids")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
      ...
      describe("#getBodyString", () => {
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getBodyString("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not a string", () => {
          should(() => request.getBodyString("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
        ...
        it("should return the default value if one is provided, and if the request has no body", () => {
          ...
          should(request.getBodyString("fullname", def)).exactly(def);
        });
      });
      ...
      describe("#getBodyObject", () => {
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getBodyObject("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an object", () => {
          should(() => request.getBodyObject("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
        ...
        it("should return the default value if one is provided, and if the request has no body", () => {
          ...
          should(request.getBodyObject("relatives", def)).exactly(def);
        });
      ...
      describe("#getBodyNumber", () => {
        ...
        it("extracts the required parameter and convert it", () => {
          should(request.getBodyNumber("age")).exactly(3011.5);

          should(request.getBodyNumber("year")).exactly(5270);
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getBodyNumber("childhood", def)).exactly(def);
        });
        ...
        it("should throw if the request does not have a body", () => {
          ...
          should(() => request.getBodyNumber("age")).throw(BadRequestError, {
            id: "api.assert.body_required",
          });
        });
        ...
        it("should return the default value if one is provided, and if the request has no body", () => {
          ...
          should(request.getBodyNumber("age", def)).exactly(def);
        });
      });
      ...
      describe("#getBodyInteger", () => {
        ...
        it("extracts the required parameter and convert it", () => {
          should(request.getBodyInteger("year")).exactly(5270);

          should(request.getBodyInteger("defeatedBugsAt")).exactly(11);
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getBodyInteger("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an integer", () => {
          should(() => request.getBodyInteger("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        ...
        it("should throw if the request does not have a body", () => {
          ...
          should(() => request.getBodyInteger("year")).throw(BadRequestError, {
            id: "api.assert.body_required",
          });
        });
        ...
        it("should return the default value if one is provided, and if the request has no body", () => {
          ...
          should(request.getBodyInteger("year", def)).exactly(def);
        });
      });
    });
    ...
    describe("#request argument getters", () => {
      ...
      describe("#getArray", () => {
        ...
        it("extracts the required parameter", () => {
          should(request.getArray("names")).exactly(request.input.args.names);
        });

        it("should throw if the parameter is missing", () => {
          should(() => request.getArray("childhood")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getArray("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an array", () => {
          should(() => request.getArray("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
        ...
        it("should try to parse if the value is a string and the protocol is HTTP", () => {
          ...
          should(request.getArray("ids")).match([1, 2, 3]);
          should(request.input.args.ids).be.an.Array().and.match([1, 2, 3]);
        });

        it("should throw if the value is a string but the protocol is not HTTP", () => {
          request.context.connection.protocol = "ws";
          should(() => request.getArray("ids")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });

        it("should throw if the parsing of the string fails to give an array", () => {
          should(() => request.getArray("fullname")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
      });
      ...
      describe("#getArrayLegacy", () => {
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getArrayLegacy("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an array", () => {
          should(() => request.getArrayLegacy("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });

        it("should try to parse if the value is a string and the protocol is HTTP", () => {
          should(request.getArrayLegacy("ids")).match([1, 2, 3]);
        });

        it("should split the split if it failed to parse the string as a JSON array when the protocol is HTTP", () => {
          should(request.getArrayLegacy("legacyArray")).match(["1", "2", "3"]);
        });
      ...
      describe("#getString", () => {
        ...
        it("should throw if the parameter is missing", () => {
          should(() => request.getString("childhood")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getString("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not a string", () => {
          should(() => request.getString("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
      });
      ...
      describe("#getObject", () => {
        ...
        it("should throw if the parameter is missing", () => {
          should(() => request.getObject("childhood")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getObject("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an object", () => {
          should(() => request.getObject("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
        ...
        it("should try to parse if the value is a string and the protocol is HTTP", () => {
          ...
          should(request.getObject("powers")).match({ fire: 666 });
          should(request.input.args.powers).be.an.Object().and.match({
            fire: 666,
          });
        });
        ...
        it("should throw if the value is a string but the protocol is not HTTP", () => {
          request.context.connection.protocol = "ws";
          should(() => request.getObject("powers")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });

        it("should throw if the parsing of the string fails", () => {
          should(() => request.getObject("fullname")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
      });
      ...
      describe("#getDate", () => {
        it("extracts the birthdate in ISO8061 format", () => {
          should(request.getDate("birthDate")).eql("2022-04-11T00:00:00.000Z");
        });
        ...
        it("should throw if the parameter is invalid ISO8601 date", () => {
          should(() => request.getDate("badDate")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });

        it("should throw if the parameter is missing", () => {
          should(() => request.getDate("anotherDate")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
      });
      ...
      describe("#getTimestamp", () => {
        it("extracts the birthdate in timestamp format", () => {
          should(request.getTimestamp("birthDateTime")).exactly(1649635200000);
        });
      ...
      describe("#getNumber", () => {
        it("extracts the required parameter and convert it", () => {
          should(request.getNumber("age")).exactly(3011.5);

          should(request.getNumber("year")).exactly(5270);
        });

        it("should throw if the parameter is missing", () => {
          should(() => request.getNumber("childhood")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getNumber("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not a number", () => {
          should(() => request.getNumber("fullname")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
      });
      ...
      describe("#getInteger", () => {
        it("extracts the required parameter and convert it", () => {
          should(request.getInteger("year")).exactly(5270);

          should(request.getInteger("defeatedBugsAt")).exactly(11);
        });

        it("should throw if the parameter is missing", () => {
          should(() => request.getInteger("childhood")).throw(BadRequestError, {
            id: "api.assert.missing_argument",
          });
        });
        ...
        it("should return the default value if provided, when the parameter is missing", () => {
          ...
          should(request.getInteger("childhood", def)).exactly(def);
        });

        it("should throw if the parameter is not an integer", () => {
          should(() => request.getInteger("age")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });

          should(() => request.getInteger("fullname")).throw(BadRequestError, {
            id: "api.assert.invalid_type",
          });
        });
      });
    ...
    describe("#getSearchParams", () => {
      ...
      it("should extract search params when invoking the route with GET", () => {
        ...
        const { from, query, scrollTTL, searchBody, size } =
          request.getSearchParams();
