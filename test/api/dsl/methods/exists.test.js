...
describe('Test exists method', () => {
  ...
  it('should construct the filterTree with correct exists arguments', () => {
  ...
  it('should return a rejected promise if the filter argument does not contain a "field" term', () => {
  ...
  it('should return a rejected promise if the "field" term does not contain a string', () => {
  ...
  it('should register the filter in the local area in case of a "exist" filter', () => {
  ...
  it('should register the filter in the global area in case of a "not exist" filter', () => {
