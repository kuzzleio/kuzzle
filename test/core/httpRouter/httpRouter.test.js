...
const
  ...
  Router = require('../../../lib/core/httpRouter'),
...
describe('core/httpRouter', () => {
  ...
  describe('#routing requests', () => {
    ...
    it('should return an error if an exception is thrown', done => {
      ...
      mockrequire(
        '../../../lib/core/httpRouter/routeHandler',
        routeHandlerStub);

      mockrequire.reRequire('../../../lib/core/httpRouter/routePart');

      const MockRouter = mockrequire.reRequire('../../../lib/core/httpRouter');
