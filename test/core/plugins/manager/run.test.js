...
describe('PluginsManager.run', () => {
  ...
  beforeEach(() => {
    ...
    mockrequire.reRequire(`${root}/lib/core/plugins/context`);
    mockrequire.reRequire(`${root}/lib/core/plugins/privilegedContext`);
    PluginsManager = mockrequire.reRequire(`${root}/lib/core/plugins/manager`);
