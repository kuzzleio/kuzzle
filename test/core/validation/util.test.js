...
describe("Test: validation utilities", () => {
  ...
  describe("#curateStructuredFields", () => {
    const curateStructuredFields = Validation.__get__("curateStructuredFields");
    ...
    it("should return a verbose representation of fields", () => {
      const maxDepth = 3,
        ...
        fields = {
          1: [
            { path: ["aField"], type: "object" },
            { path: ["anotherField"], type: "object" },
          ],
          2: [
            { path: ["aField", "aSubField"], type: "object" },
            { path: ["aField", "anotherSubField"], type: "object" },
          ],
          3: [
            { path: ["aField", "aSubField", "aSubSubField"], type: "object" },
            {
  ...
  describe("#getParent", () => {
    const getParent = Validation.__get__("getParent");
  ...
  describe("#manageErrorMessage", () => {
    ...
    it("should throw an error if verbose is false and context is not document", () => {
      const context = ["aField", "aSubField"],
        verbose = false,
        message = "a message",
        errorHolder = [];
