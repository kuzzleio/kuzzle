...
const
  ...
  HttpFormDataStream = require(`${root}/lib/core/entrypoints/service/httpFormDataStream`),
  EntryPoint = require(`${root}/lib/core/entrypoints`),
  ClientConnection = require(`${root}/lib/core/entrypoints/clientConnection`),
  { HttpMessage } = require(`${root}/lib/core/entrypoints/protocols/http`),
...
describe('/lib/core/entrypoints/protocols/http', () => {
  const
  ...
  before(() => {
    ...
    HttpProtocol = mockrequire
      .reRequire(`${root}/lib/core/entrypoints/protocols/http`)
      .HttpProtocol;
  });
