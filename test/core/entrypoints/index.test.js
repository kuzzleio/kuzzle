...
describe('lib/core/core/entrypoints/index', () => {
  let
    kuzzle,
    HttpMock,
    WebSocketMock,
  ...
  beforeEach(() => {
    ...
    const entryPointPath = `${root}/lib/core/entrypoints`;
  ...
  describe('#loadMoreProtocols', () => {
    const
      protocolDir = path.join(__dirname, `${root}/protocols/enabled`),
      entryPointDir = `${root}/lib/core/entrypoints`;
